...
test.describe("Inventory Module", () => {
  ...
  test.describe("Inventory Dashboard", () => {
    ...
    test("should display charts", async ({ page }) => {
      ...
      await expect(
        page.getByText("Movimentações dos Últimos 7 Dias"),
      ).toBeVisible();
  ...
  test.describe("Product Registrations", () => {
    ...
    test("should create new product", async ({ page }) => {
      ...
      // Check success toast
      await expect(page.getByText(/produto cadastrado/i)).toBeVisible({
        timeout: 5000,
      });
    });
  ...
  test.describe("Category Registrations", () => {
    ...
    test("should create categoria", async ({ page }) => {
      ...
      await expect(page.getByText(/categoria cadastrada/i)).toBeVisible({
        timeout: 5000,
      });
    });
  });
  ...
  test.describe("Stock Movements", () => {
    ...
    test("should display metrics cards with elevated variant", async ({
      page,
    }) => {
      await page.goto("/estoque/movimentacoes");
