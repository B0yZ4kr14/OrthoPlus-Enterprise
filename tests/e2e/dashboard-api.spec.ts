...
test.describe("Dashboard API Integration", () => {
  ...
  test("should display correct stats structure", async ({ page }) => {
    ...
    const totalPatients = await page
      .locator("text=/Total de Pacientes/i")
      .isVisible();
    expect(totalPatients).toBeTruthy();

    const todayAppointments = await page
      .locator("text=/Consultas Hoje/i")
      .isVisible();
    expect(todayAppointments).toBeTruthy();

    const monthlyRevenue = await page
      .locator("text=/Receita Mensal/i")
      .isVisible();
  ...
  test("should render appointments chart", async ({ page }) => {
    ...
    const appointmentsChart = await page
      .locator("text=/Visão Geral de Consultas/i")
      .isVisible();
  ...
  test("should render revenue chart", async ({ page }) => {
    ...
    const revenueChart = await page
      .locator("text=/Desempenho Financeiro/i")
      .isVisible();
