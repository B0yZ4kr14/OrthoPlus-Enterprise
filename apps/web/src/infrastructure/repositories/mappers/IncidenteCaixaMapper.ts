...
type IncidenteCaixaRow =
  Database["public"]["Tables"]["caixa_incidentes"]["Row"];
type IncidenteCaixaInsert =
  Database["public"]["Tables"]["caixa_incidentes"]["Insert"];
...
export class IncidenteCaixaMapper {
  ...
  static toDomain(row: IncidenteCaixaRow): IncidenteCaixa {
    return IncidenteCaixa.restore({
      ...
      valorCaixaMomento: row.valor_caixa_momento
        ? Number(row.valor_caixa_momento)
        : undefined,
