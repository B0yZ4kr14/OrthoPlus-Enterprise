...
export function ExameClinicoTab({ patient }: ExameClinicoTabProps) {
  ...
  const getBPStatus = (systolic: number | null, diastolic: number | null) => {
    ...
    if (systolic < 140 || diastolic < 90)
      return { label: "Hipertensão Estágio 1", color: "text-warning" };
          ...
          <div>
            ...
            {patient.oral_hygiene_quality ? (
              <div className="mt-2">
                <Badge
                  variant={
                    patient.oral_hygiene_quality === "excelente"
                      ? "default"
                      : patient.oral_hygiene_quality === "boa"
                        ? "secondary"
                        : patient.oral_hygiene_quality === "regular"
                          ? "outline"
                          : "destructive"
                  }
          ...
          <div>
            ...
            {patient.gum_condition ? (
              <div className="mt-2">
                <Badge
                  variant={
                    patient.gum_condition === "saudavel"
                      ? "default"
                      : patient.gum_condition === "gengivite"
                        ? "outline"
                        : "destructive"
                  }
                  className="text-base py-1.5"
