  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent className="space-y-4">
          {patient.has_systemic_disease ? (
            ...
            <p className="text-muted-foreground">
              Nenhuma doença sistêmica reportada
            </p>
          )}
        </CardContent>
      </Card>
                ...
                <>
                  ...
                  {patient.hypertension_controlled !== null && (
                    <Badge
                      className="ml-2"
                      variant={
                        patient.hypertension_controlled ? "success" : "warning"
                      }
                    >
                      {patient.hypertension_controlled
                        ? "Controlada"
                        : "Não Controlada"}
                    </Badge>
                  )}
                ...
                <>
                  ...
                  {patient.diabetes_controlled !== null && (
                    <Badge
                      className="ml-2"
                      variant={
                        patient.diabetes_controlled ? "success" : "warning"
                      }
                    >
                      {patient.diabetes_controlled
                        ? "Controlada"
                        : "Não Controlada"}
                    </Badge>
                  )}
      ...
      <Card>
        ...
        <CardContent>
          ...
          patient.current_medications.length > 0 ? (
            ...
            <p className="text-muted-foreground">
              Nenhum medicamento em uso reportado
            </p>
          )}
        </CardContent>
      </Card>
      ...
      {patient.gender === "feminino" &&
        (patient.is_pregnant || patient.is_breastfeeding) && (
          <Card>
            <CardHeader>
                ...
                <div>
                  ...
                  <p className="text-lg">
                    ...
                    {patient.pregnancy_trimester && (
                      <span className="ml-2 text-sm">
                        {patient.pregnancy_trimester}º Trimestre
                      </span>
                    )}
                  </p>
                </div>
