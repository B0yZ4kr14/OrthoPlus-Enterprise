    ...
    <div className="space-y-3">
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center justify-between">
          <p
            className={`text-sm font-medium transition-colors ${getTextColorClass(strength.color)}`}
          >
      ...
      {password.length > 0 && strength.score < 4 && (
        <div className="flex items-start gap-2 p-2 bg-amber-500/10 rounded-md border border-amber-500/20">
          ...
          <p className="text-xs text-amber-700 dark:text-amber-300">
            <strong>Dica:</strong> Use uma combinação de letras, números e
            símbolos. Evite sequências óbvias (123, abc) e informações pessoais.
          </p>
        </div>
      )}
    </div>
