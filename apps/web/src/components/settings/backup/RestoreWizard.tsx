          ...
          <div className="space-y-4 py-4">
            <Alert variant="destructive">
              ...
              <AlertDescription>
                ...
                atuais do sistema. Certifique-se de ter um backup recente antes
                de continuar.
              </AlertDescription>
            </Alert>
            ...
            <div className="bg-muted p-4 rounded-lg space-y-2">
              ...
              <ul className="text-sm space-y-1 ml-7 text-muted-foreground">
                <li>
                  • Todos os dados serão revertidos para{" "}
            ...
            <Alert>
              ...
              <AlertDescription>
                Recomendamos criar um backup dos dados atuais antes de
                prosseguir.
              </AlertDescription>
            </Alert>
          </div>
