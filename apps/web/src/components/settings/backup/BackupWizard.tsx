      ...
      <DialogContent className="sm:max-w-[600px]">
            ...
            <RadioGroup value={backupType} onValueChange={setBackupType}>
              <div className="flex items-center space-x-2 border rounded-lg p-4 cursor-pointer hover:bg-accent">
                ...
                <Label htmlFor="full" className="flex-1 cursor-pointer">
                  ...
                  <div className="text-sm text-muted-foreground">
                    Cópia completa de todos os dados selecionados
                  </div>
                </Label>
              </div>
              <div className="flex items-center space-x-2 border rounded-lg p-4 cursor-pointer hover:bg-accent">
              ...
              <div className="flex items-center space-x-2 border rounded-lg p-4 cursor-pointer hover:bg-accent">
                ...
                <Label htmlFor="differential" className="flex-1 cursor-pointer">
                  ...
                  <div className="text-sm text-muted-foreground">
                    Dados modificados desde o último backup completo
                  </div>
                </Label>
              </div>
            </RadioGroup>
            ...
            <div className="bg-muted p-4 rounded-lg space-y-2">
              ...
              <div className="text-sm space-y-1 ml-7">
                ...
                <p>
                  Dados:{" "}
                  <span className="font-medium">
                    {selectedData.length} categorias
                  </span>
                </p>
                <p>
                  Compressão:{" "}
                  <span className="font-medium">
                    {compression ? "Ativada" : "Desativada"}
                  </span>
                </p>
                <p>
                  Criptografia:{" "}
                  <span className="font-medium">
                    {encryption ? "Ativada" : "Desativada"}
                  </span>
                </p>
              </div>
            </div>
        ...
        <DialogFooter>
          ...
          {step < 3 ? (
            ...
            <Button type="button" onClick={handleConfirm}>Confirmar Backup</Button>
          )}
        </DialogFooter>
      </DialogContent>
    </Dialog>
