  ...
  return (
    ...
    >
      ...
      <CardHeader className="flex flex-row items-center justify-between pb-1 pt-5 px-5">
        ...
        <div className={cn("p-2 rounded-lg shadow-sm group-hover:shadow-md transition-shadow", iconBg[variant])}>
      ...
      <CardContent className="pt-0 pb-5 px-5">
        ...
        {description && (
          <p className="text-[11px] text-muted-foreground/60 mt-2 leading-relaxed">{description}</p>
        )}
      </CardContent>
    </Card>
  );
