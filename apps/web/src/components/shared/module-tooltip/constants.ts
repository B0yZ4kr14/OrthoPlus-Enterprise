...
export const MODULE_DATA: Record<string, ModuleInfo> = {
  PEP: {
    ...
    description:
      "Sistema completo de gestão de prontuários digitais com histórico clínico, anamnese, evoluções e anexos.",
    dependencies: [],
    benefits: [
  ...
  AGENDA: {
    ...
    category: "Atendimento Clínico",
    description:
      "Agenda visual com confirmação automática via WhatsApp, lembretes e otimização de horários.",
    dependencies: [],
    benefits: [
  ...
  FINANCEIRO: {
    ...
    description:
      "Controle completo de fluxo de caixa, contas a pagar e receber, DRE e relatórios financeiros.",
    dependencies: [],
    benefits: [
  ...
  CRYPTO: {
    ...
    category: "Gestão Financeira",
    description:
      "Aceite Bitcoin, USDT e outras criptomoedas. Conversão automática para BRL e integração com exchanges.",
  ...
  SPLIT_PAGAMENTO: {
    ...
    category: "Gestão Financeira",
    description:
      "Divisão automática de pagamentos entre dentistas e clínica com otimização tributária.",
    dependencies: ["FINANCEIRO"],
    benefits: [
  ...
  INADIMPLENCIA: {
    ...
    category: "Gestão Financeira",
    description:
      "Cobrança automatizada via WhatsApp e e-mail com escalonamento inteligente.",
    dependencies: ["FINANCEIRO"],
    benefits: [
  ...
  ORCAMENTOS: {
    ...
    category: "Atendimento Clínico",
    description:
      "Criação de orçamentos profissionais, contratos digitais e assinatura eletrônica.",
  ...
  ODONTOGRAMA: {
    ...
    category: "Atendimento Clínico",
    description:
      "Odontograma interativo 2D e visualização 3D com marcação de procedimentos realizados e planejados.",
    dependencies: [],
    benefits: [
  ...
  ESTOQUE: {
    ...
    category: "Atendimento Clínico",
    description:
      "Gestão completa de estoque com scanner mobile, pedidos automáticos e análise de consumo.",
    dependencies: [],
    benefits: [
  ...
  CRM: {
    ...
    description:
      "Gestão de leads e oportunidades com funil visual e automação de follow-up.",
    dependencies: [],
    benefits: [
  ...
  MARKETING_AUTO: {
    ...
    category: "Relacionamento & Vendas",
    description:
      "Campanhas automatizadas de recall, pós-consulta, aniversário e segmentação de pacientes.",
    dependencies: [],
    benefits: [
  ...
  BI: {
    ...
    category: "Relacionamento & Vendas",
    description:
      "Dashboards personalizados, relatórios automatizados e análise de indicadores-chave.",
    dependencies: [],
    benefits: [
  ...
  LGPD: {
    ...
    description:
      "Gestão de consentimentos, solicitações de dados, logs de auditoria e conformidade com LGPD.",
    dependencies: [],
    benefits: [
  ...
  ASSINATURA_ICP: {
    ...
    category: "Conformidade & Legal",
    description:
      "Assinatura digital com certificado ICP-Brasil (validade jurídica plena).",
    dependencies: ["PEP"],
    benefits: [
  ...
  TISS: {
    ...
    category: "Conformidade & Legal",
    description:
      "Geração de guias TISS (XML), envio para operadoras e rastreamento de reembolsos.",
    dependencies: ["PEP"],
    benefits: [
  ...
  TELEODONTO: {
    ...
    category: "Conformidade & Legal",
    description:
      "Teleconsultas com vídeo, gravação automática e conformidade com CFO.",
    dependencies: [],
    benefits: [
  ...
  FLUXO_DIGITAL: {
    ...
    description:
      "Integração com scanners intraorais e envio automático para laboratórios CAD/CAM.",
    dependencies: ["PEP"],
    benefits: [
  ...
  IA: {
    ...
    category: "Tecnologias Avançadas",
    description:
      "Análise automática de raio-X, detecção de problemas e sugestões de diagnóstico.",
