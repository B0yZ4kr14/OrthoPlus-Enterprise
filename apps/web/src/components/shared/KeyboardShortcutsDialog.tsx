...
const shortcuts: KeyboardShortcut[] = [
  ...
  {
    key: "Ctrl + P",
    description: "Busca Rápida de Pacientes",
    category: "Busca",
  },
  ...
  {
    key: "Ctrl + O",
    description: "Abrir Prontuário (menu contextual)",
    category: "Ações Rápidas",
  },
  {
    key: "Ctrl + A",
    description: "Agendar Consulta (menu contextual)",
    category: "Ações Rápidas",
  },
  ...
  {
    key: "Shift + ?",
    description: "Exibir este menu de atalhos",
    category: "Ajuda",
  },
