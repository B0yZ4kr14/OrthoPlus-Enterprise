...
export const patientFormSchema = z.object({
  ...
  smoking_frequency: z
    .enum(["leve", "moderado", "pesado"])
    .optional()
    .nullable(),
  has_alcohol_habit: z.boolean().optional().nullable(),
  alcohol_frequency: z
    .enum(["ocasional", "moderado", "frequente"])
    .optional()
    .nullable(),
  ...
  oral_hygiene_quality: z
    .enum(["excelente", "boa", "regular", "ruim"])
    .optional()
    .nullable(),
  gum_condition: z
    .enum(["saudavel", "leve_inflamacao", "gengivite", "periodontite"])
    .optional()
    .nullable(),
