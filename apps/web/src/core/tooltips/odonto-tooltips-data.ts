...
export const odontoTooltipsData: Record<string, OdontoTooltip> = {
  ...
  PEP: {
    ...
    definition:
      "Sistema digital para registro completo do histórico clínico, anamnese, diagnósticos, tratamentos e evolução do paciente.",
    indications: [
  ...
  AGENDA: {
    ...
    definition:
      "Sistema de agendamento automatizado com confirmações, lembretes e gestão de horários via WhatsApp integrado.",
    indications: [
  ...
  ORCAMENTOS: {
    ...
    definition:
      "Sistema para criação, aprovação e gestão de orçamentos odontológicos com contratos digitais assinados.",
    indications: [
  ...
  ODONTOGRAMA: {
    ...
    definition:
      "Mapa visual interativo da arcada dentária para registro de condições, procedimentos realizados e planejados.",
    indications: [
  ...
  ESTOQUE: {
    ...
    definition:
      "Sistema de gestão de materiais odontológicos com controle de entrada, saída, validade e ponto de reposição.",
    indications: [
  ...
  FINANCEIRO: {
    ...
    definition:
      "Sistema completo de controle financeiro incluindo receitas, despesas, fluxo de caixa e relatórios gerenciais.",
    indications: [
  ...
  SPLIT_PAGAMENTO: {
    ...
    definition:
      "Sistema de divisão automática de pagamentos entre profissionais com planejamento tributário inteligente.",
    indications: [
  ...
  INADIMPLENCIA: {
    ...
    definition:
      "Sistema automatizado de gestão de recebíveis com régua de cobrança personalizada e negociação.",
    indications: [
  ...
  CRM: {
    ...
    definition:
      "Sistema de gestão de relacionamento com leads e pacientes, incluindo funil de conversão e jornada do cliente.",
    indications: [
  ...
  MARKETING_AUTO: {
    ...
    definition:
      "Sistema automatizado de engajamento pós-atendimento com recalls, pesquisas de satisfação e reativação.",
    indications: [
  ...
  BI: {
    ...
    definition:
      "Plataforma de análise de dados com dashboards executivos e indicadores de desempenho (KPIs) da clínica.",
    indications: [
  ...
  LGPD: {
    ...
    definition:
      "Sistema de gestão de dados pessoais conforme Lei Geral de Proteção de Dados com auditorias e consentimentos.",
    indications: [
  ...
  ASSINATURA_ICP: {
    ...
    definition:
      "Sistema de assinatura eletrônica com certificado digital padrão ICP-Brasil para validade jurídica.",
    indications: [
  ...
  TISS: {
    ...
    definition:
      "Sistema de faturamento para operadoras de planos de saúde seguindo padrão TISS da ANS.",
    indications: [
  ...
  TELEODONTO: {
    ...
    definition:
      "Plataforma de atendimento remoto conforme Resolução CFO-226/2020 para teleconsultas e telemonitoramento.",
    indications: [
  ...
  FLUXO_DIGITAL: {
    ...
    definition:
      "Integração com scanners intraorais e laboratórios para fluxo digital completo de próteses e ortodontia.",
    indications: [
  ...
  IA: {
    ...
    definition:
      "Ferramentas de IA para análise de radiografias, predição de tratamentos e assistência diagnóstica.",
    indications: [
  ...
  ANAMNESE: {
    ...
    definition:
      "Questionário estruturado de histórico médico e odontológico do paciente para avaliação de riscos.",
    indications: [
  ...
  PRESCRICAO: {
    ...
    definition:
      "Sistema de prescrição eletrônica com banco de dados de medicamentos, posologia e interações.",
    indications: [
  ...
  RADIOLOGIA: {
    ...
    definition:
      "Sistema PACS para armazenamento e visualização de imagens radiográficas digitais com emissão de laudos.",
    indications: [
...
export function getTooltipsByCategory(
  category: OdontoTooltip["category"],
): OdontoTooltip[] {
  return Object.values(odontoTooltipsData).filter(
    (t) => t.category === category,
  );
}

// Função helper para buscar tooltips por nível de risco
export function getTooltipsByRiskLevel(
  riskLevel: OdontoTooltip["riskLevel"],
): OdontoTooltip[] {
  return Object.values(odontoTooltipsData).filter(
