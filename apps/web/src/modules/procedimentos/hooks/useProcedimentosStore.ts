...
const procedimentosIniciais: Procedimento[] = [
  ...
  },
  {
    ...
    descricao:
      "Remoção da polpa dentária infectada e preenchimento dos canais radiculares",
    valor: 800.0,
    duracaoEstimada: 1,
    unidadeTempo: "horas",
    materiaisNecessarios:
      "Limas endodônticas, guta-percha, cimento endodôntico, isolamento absoluto",
  ...
  },
  {
    ...
    unidadeTempo: "horas",
    materiaisNecessarios:
      "Brackets metálicos, arcos ortodônticos, bandas, cimento",
  ...
  },
  {
    ...
    unidadeTempo: "minutos",
    materiaisNecessarios:
      "Resina composta, ácido fosfórico, adesivo, fotopolimerizador",
    status: "Ativo",
...
export function useProcedimentosStore() {
  ...
  const atualizarProcedimento = (
    id: string,
    dados: Partial<CriarProcedimento>,
  ) => {
    setProcedimentos(
