...
export function TechnicalIndicators({ rates }: TechnicalIndicatorsProps) {
    ...
    return (
      <Card depth="normal">
        <CardHeader>
          ...
          <CardDescription>
            Dados insuficientes para análise técnica
          </CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-sm text-muted-foreground">
            São necessários pelo menos 14 dias de histórico para calcular os
  ...
  // Interpretações
  const rsiSignal =
    rsi > 70 ? "SOBRECOMPRADO" : rsi < 30 ? "SOBREVENDIDO" : "NEUTRO";
  const rsiVariant =
    rsi > 70 ? "destructive" : rsi < 30 ? "success" : "secondary";
    ...
    <Card depth="normal">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            {rsi > 70
              ? "⚠️ Ativo pode estar sobrecomprado (pode cair)"
              : rsi < 30
                ? "✅ Ativo pode estar sobrevendido (oportunidade de compra)"
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Volatilidade e Suporte/Resistência
              </p>
            </div>
          ...
          <div className="grid grid-cols-3 gap-2 text-xs">
            <div className="text-center">
              ...
              <div className="font-semibold">
                R${" "}
                {bollinger.upper.toLocaleString("pt-BR", {
            ...
            <div className="text-center">
              ...
              <div className="font-semibold">
                R${" "}
                {bollinger.middle.toLocaleString("pt-BR", {
                  maximumFractionDigits: 0,
                })}
              </div>
            </div>
            <div className="text-center">
              ...
              <div className="font-semibold">
                R${" "}
                {bollinger.lower.toLocaleString("pt-BR", {
                  maximumFractionDigits: 0,
                })}
              </div>
            </div>
          ...
          <p className="text-xs text-muted-foreground">
            {currentPrice > bollinger.upper
              ? "⚠️ Preço acima da banda superior (pode cair)"
              : currentPrice < bollinger.lower
                ? "✅ Preço abaixo da banda inferior (oportunidade)"
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Convergência e Divergência de Médias
              </p>
            </div>
          ...
          <div className="grid grid-cols-3 gap-2 text-xs">
            ...
            <div>
              ...
              <div
                className={`font-semibold ${macd.histogram >= 0 ? "text-success" : "text-destructive"}`}
              >
                {macd.histogram >= 0 ? (
          ...
          <p className="text-xs text-muted-foreground">
            {macd.histogram > 0
              ? "✅ Momentum positivo (sinal de compra)"
              : macd.histogram < 0
                ? "⚠️ Momentum negativo (sinal de venda)"
                : "Sem momentum claro"}
          </p>
        </div>
        ...
        <div className="pt-4 border-t">
          ...
          <p className="text-xs text-muted-foreground mt-3 italic">
            * Indicadores técnicos são ferramentas de análise e não garantem
            resultados futuros. Sempre considere múltiplos fatores antes de
