...
describe("Landpage", () => {
  ...
  it("should render the page without crashing", () => {
    render(<Landpage />);
    expect(
      screen.getAllByText("OrthoPlus Enterprise").length,
  ...
  it("should render pricing section heading", () => {
    ...
    expect(
      screen.getByText(/Escolha o plano ideal para o tamanho da sua operação/i),
    ).toBeTruthy();
  });
  ...
  it("should render footer with contact email", () => {
    ...
    expect(screen.getByText(/OrthoPlus Enterprise © 2026/)).toBeTruthy();
  });

  it("should render footer navigation links", () => {
    render(<Landpage />);
    expect(
      screen.getAllByText("Entrar no Sistema").length,
