            ...
            <CardContent className="space-y-6">
              ...
              <div className="p-4 border rounded-lg space-y-4">
                <h3 className="font-semibold">
                  1 - Relatório Analítico de Contratos
                </h3>
              ...
              <div className="p-4 border rounded-lg space-y-4">
                <h3 className="font-semibold">
                  2 - Relatório Sintético por Campanha
                </h3>
              ...
              <div className="p-4 border rounded-lg space-y-4">
                <h3 className="font-semibold">
                  3 - Relatório Sintético por Funcionário
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label>De:</Label>
                ...
                <Button
                  className="w-full"
                  onClick={() =>
                    handleGenerateReport("Sintético por Funcionário")
                  }
                >
                  <Download className="mr-2 h-4 w-4" />
                  Gerar Relatório
              ...
              <div className="p-4 border rounded-lg space-y-4">
                <h3 className="font-semibold">
                  4 - Relatório Comercial de Contratos Não Fechados
                </h3>
        ...
        <TabsContent value="pacientes" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Análises sobre tratamentos, agendamentos e histórico de
                pacientes
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="p-4 border rounded-lg space-y-4">
                <h3 className="font-semibold">
                  1 - Pacientes com Tratamento em Andamento/Futuro
                </h3>
                <Button
                  className="w-full"
                  onClick={() =>
                    handleGenerateReport("Tratamento em Andamento")
                  }
                >
                  <Download className="mr-2 h-4 w-4" />
                  Gerar Relatório
              ...
              <div className="p-4 border rounded-lg space-y-4">
                <h3 className="font-semibold">
                  2 - Pacientes que Estarão Sem Agendamento
                </h3>
                <div>
                  <Label>Data:</Label>
                  <Input type="date" />
              ...
              <div className="p-4 border rounded-lg space-y-4">
                <h3 className="font-semibold">
                  6 - Relatório de Orçamentos Clínicos
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <Label>De:</Label>
              ...
              <div className="p-4 border rounded-lg space-y-4">
                <h3 className="font-semibold">
                  7 - Relatório Tempo Médio de Tratamento Por Dentista
                </h3>
                <Button
                  className="w-full"
                  onClick={() =>
                    handleGenerateReport("Tempo Médio por Dentista")
                  }
                >
                  <Download className="mr-2 h-4 w-4" />
                  Gerar Relatório
        ...
        <TabsContent value="profissionais" className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="p-4 border rounded-lg space-y-4">
                <h3 className="font-semibold">
                  4 - Funcionários e suas Permissões
                </h3>
                <Button
                  className="w-full"
                  onClick={() =>
                    handleGenerateReport("Funcionários e Permissões")
                  }
                >
                  <Download className="mr-2 h-4 w-4" />
                  Gerar Relatório
        ...
        <TabsContent value="financeiro" className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="p-4 border rounded-lg space-y-4">
                <h3 className="font-semibold">
                  1 - Contas Recebidas/Adiantamentos Bruto
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <Label>Tipo:</Label>
              ...
              <div className="p-4 border rounded-lg space-y-4">
                ...
                <Button
                  className="w-full"
                  onClick={() =>
                    handleGenerateReport("Lançamentos Financeiros")
                  }
                >
                  <Download className="mr-2 h-4 w-4" />
                  Gerar Relatório
              ...
              <div className="p-4 border rounded-lg space-y-4">
                <h3 className="font-semibold">
                  8 - Visão de Pagamentos de Serviços
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
