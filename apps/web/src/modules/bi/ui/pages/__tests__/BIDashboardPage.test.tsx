...
describe("BIDashboardPage", () => {
  ...
  it("should render financial tab content with placeholder", () => {
    ...
    expect(
      screen.getByText("Gráficos e métricas financeiras em desenvolvimento"),
    ).toBeTruthy();
  });
  ...
  it("should render patients tab content with placeholder", () => {
    ...
    expect(
      screen.getByText("Métricas de pacientes em desenvolvimento"),
    ).toBeTruthy();
  });
  ...
  it("should render performance tab content with placeholder", () => {
    ...
    expect(
      screen.getByText("Indicadores de performance em desenvolvimento"),
    ).toBeTruthy();
  });
  ...
  it("should render dashboard data when available", () => {
    mockUseBIDashboards.mockReturnValue({
      ...
      metrics: [{ id: "met-1", name: "Receita Total", value: 150000 }],
      isLoading: false,
      createDashboard: vi.fn(),
    });
