...
const workflowOptimizations = [
  {
    ...
    descricao:
      "Detectamos que 35% dos acessos ao PEP ocorrem entre 12h-13h (horário de almoço). Considere implementar lembretes para preenchimento durante consultas.",
    impacto: "high",
  ...
  },
  {
    ...
    descricao:
      "3 usuários geram os mesmos relatórios diariamente. Configure templates automáticos para economizar tempo.",
    impacto: "low",
  ...
  },
  {
    ...
    descricao:
      "Usuários gastam em média 8 minutos cadastrando pacientes. Implemente auto-preenchimento de dados a partir de documentos.",
    impacto: "high",
