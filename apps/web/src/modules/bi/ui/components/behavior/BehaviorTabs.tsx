...
const hourlyUsageData = [
  { hour: "00h", acessos: 5 }, { hour: "01h", acessos: 3 },
  { hour: "02h", acessos: 2 }, { hour: "03h", acessos: 1 },
  { hour: "04h", acessos: 2 }, { hour: "05h", acessos: 4 },
  { hour: "06h", acessos: 8 }, { hour: "07h", acessos: 15 },
  { hour: "08h", acessos: 45 }, { hour: "09h", acessos: 78 },
  { hour: "10h", acessos: 92 }, { hour: "11h", acessos: 85 },
  { hour: "12h", acessos: 35 }, { hour: "13h", acessos: 40 },
  { hour: "14h", acessos: 88 }, { hour: "15h", acessos: 95 },
  { hour: "16h", acessos: 82 }, { hour: "17h", acessos: 65 },
  { hour: "18h", acessos: 42 }, { hour: "19h", acessos: 28 },
  { hour: "20h", acessos: 18 }, { hour: "21h", acessos: 12 },
  { hour: "22h", acessos: 8 }, { hour: "23h", acessos: 6 },
];
...
const workflowOptimizations = [
  {
    ...
    descricao: "Detectamos que 35% dos acessos ao PEP ocorrem entre 12h-13h. Considere implementar lembretes para preenchimento durante consultas.",
    impacto: "high" as const, economia_tempo: "2.5h/dia", usuarios_afetados: 12,
  },
  {
    id: 2,
    ...
    impacto: "medium" as const, economia_tempo: "1.8h/dia", usuarios_afetados: 8,
  },
  {
    id: 3,
    titulo: "Relatórios sendo gerados repetidamente",
    descricao: "3 usuários geram os mesmos relatórios diariamente. Configure templates automáticos.",
    impacto: "low" as const, economia_tempo: "0.5h/dia", usuarios_afetados: 3,
  },
  {
    id: 4,
    titulo: "Fluxo de cadastro de pacientes pode ser otimizado",
    descricao: "Usuários gastam em média 8 minutos cadastrando pacientes. Implemente auto-preenchimento.",
    impacto: "high" as const, economia_tempo: "3.2h/dia", usuarios_afetados: 15,
  },
];

export function UsagePatternsTab() {
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle>Horários de Pico - Acessos por Hora</CardTitle>
          <CardDescription>Análise de volume de acessos ao longo do dia</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Evolução de usuários ativos e sessões nos últimos 12 dias</CardDescription>
        </CardHeader>
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Ranking de módulos por volume de acessos e tempo médio de uso</CardDescription>
      </CardHeader>
      <CardContent>
            ...
            <div key={modulo.modulo} className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="w-full bg-muted rounded-full h-2">
                  <div className="h-2 rounded-full" style={{ width: `${(modulo.acessos / 1245) * 100}%`, backgroundColor: modulo.cor }} />
                </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Classificação de usuários por tempo de uso diário</CardDescription>
        </CardHeader>
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              <Pie data={userEngagementData} cx="50%" cy="50%" labelLine={false} label={({ valor }) => `${valor}%`} outerRadius={80} fill="#8884d8" dataKey="valor">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Indicadores de retorno e engajamento de usuários</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          {[
            { label: "Taxa de Retorno (7 dias)", value: "87%", width: "87%", color: "bg-success" },
            { label: "Taxa de Retorno (30 dias)", value: "92%", width: "92%", color: "bg-success" },
            { label: "Usuários Diários Ativos", value: "68%", width: "68%", color: "bg-primary" },
            { label: "Satisfação do Usuário (NPS)", value: "8.5/10", width: "85%", color: "bg-chart-2" },
          ].map((metric) => (
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Recomendações baseadas em análise de padrões comportamentais</CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          {workflowOptimizations.map((opt) => (
            <div key={opt.id} className="border rounded-lg p-4 space-y-3 hover:border-primary/50 transition-colors">
                ...
                <div className="flex items-start gap-3 flex-1">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-xs text-muted-foreground">{opt.usuarios_afetados} usuários afetados</span>
                    </div>
                  </div>
                </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground"><span className="text-success">+8%</span> vs mês anterior</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">95 acessos simultâneos</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground"><span className="text-success">+12%</span> de engajamento</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">Economia de <span className="text-success">8h/dia</span></p>
        </CardContent>
      </Card>
    </div>
  );
