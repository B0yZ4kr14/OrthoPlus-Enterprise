...
const workflowOptimizations = [
  {
    ...
    descricao:
      "Detectamos que 35% dos acessos ao PEP ocorrem entre 12h-13h. Considere implementar lembretes para preenchimento durante consultas.",
  ...
  },
  {
    ...
    descricao:
      "Apenas 45% das consultas são agendadas através do módulo. Usuários ainda utilizam anotações manuais.",
  ...
  },
  {
    ...
    descricao:
      "3 usuários geram os mesmos relatórios diariamente. Configure templates automáticos.",
    impacto: "low" as const,
  ...
  },
  {
    ...
    descricao:
      "Usuários gastam em média 8 minutos cadastrando pacientes. Implemente auto-preenchimento.",
    impacto: "high" as const,
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center justify-between mt-1">
                  <span className="text-xs text-muted-foreground">
                    Tempo médio: {modulo.tempo_medio}
                  </span>
                </div>
              </div>
            </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          {[
            {
              label: "Taxa de Retorno (7 dias)",
              value: "87%",
              width: "87%",
              color: "bg-success",
            },
            {
              label: "Taxa de Retorno (30 dias)",
              value: "92%",
              width: "92%",
              color: "bg-success",
            },
            {
              label: "Usuários Diários Ativos",
              value: "68%",
              width: "68%",
              color: "bg-primary",
            },
            {
              label: "Satisfação do Usuário (NPS)",
              value: "8.5/10",
              width: "85%",
              color: "bg-chart-2",
            },
