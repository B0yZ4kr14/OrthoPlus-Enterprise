...
vi.mock("@/modules/lgpd/presentation/components/LGPDRequests", () => ({
  LGPDRequests: () => <div data-testid="lgpd-requests">LGPDRequests Component</div>,
}))

vi.mock("@/modules/lgpd/presentation/components/LGPDConsents", () => ({
  LGPDConsents: () => <div data-testid="lgpd-consents">LGPDConsents Component</div>,
}))

vi.mock("@/modules/lgpd/presentation/components/LGPDAuditTrail", () => ({
  LGPDAuditTrail: () => <div data-testid="lgpd-audit">LGPDAuditTrail Component</div>,
}))
...
describe("LGPDPage", () => {
  ...
  it("should render page header with correct title and description", () => {
    ...
    expect(screen.getByText("Gestão de privacidade e proteção de dados")).toBeTruthy()
  })
