        ...
        <div className="lg:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Ative ou desative os módulos contratados pela sua clínica.
                Solicite novos módulos conforme necessário.
              </CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                          {category.modules.filter((m) => m.subscribed).length}{" "}
                          de {category.modules.length} módulos contratados
                        </p>
                      </div>
                      <Badge variant="secondary">
                        {category.modules.filter((m) => m.is_active).length}{" "}
                        ativos
                      </Badge>
                    </div>
