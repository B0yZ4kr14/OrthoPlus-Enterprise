      ...
      <Tabs defaultValue="exchanges" className="space-y-4">
        ...
        <TabsContent value="exchanges" className="space-y-4">
          ...
          {exchanges.length === 0 ? (
            <Card className="p-8 text-center text-muted-foreground">
              Nenhuma exchange configurada. Clique em "Adicionar Exchange" para
              começar.
            </Card>
          ) : (
        ...
        <TabsContent value="wallets" className="space-y-4">
          ...
          {offlineWallets.length === 0 ? (
            <Card className="p-8 text-center text-muted-foreground">
              Nenhuma wallet offline configurada. Use sua Hardware Wallet
              (Trezor, Coldcard, KRUX).
            </Card>
          ) : (
            <div className="grid gap-4">
        ...
        <TabsContent value="btcpay" className="space-y-4">
          <Card className="p-6">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              BTCPay Server é uma solução self-hosted para pagamentos Bitcoin
              não-custodiais. Requer infraestrutura própria (Docker, Bitcoin
              Node).
            </p>
