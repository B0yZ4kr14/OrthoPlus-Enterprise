...
const FALLBACK_TEMPLATES: Record<string, { name: string; ddl: string }[]> = {
  CORE: [
    { name: 'patients', ddl: 'CREATE TABLE pacientes.patients (\n  id UUID PRIMARY KEY,\n  name VARCHAR(255) NOT NULL,\n  created_at TIMESTAMPTZ DEFAULT NOW()\n);' },
    { name: 'appointments', ddl: 'CREATE TABLE core.appointments (\n  id UUID PRIMARY KEY,\n  patient_id UUID REFERENCES pacientes.patients(id),\n  scheduled_at TIMESTAMPTZ NOT NULL\n);' },
    { name: 'profiles', ddl: 'CREATE TABLE core.profiles (\n  id UUID PRIMARY KEY,\n  user_id UUID NOT NULL,\n  clinic_id UUID NOT NULL\n);' },
  ],
  FINANCEIRO: [
    { name: 'financial_transactions', ddl: 'CREATE TABLE financeiro.financial_transactions (\n  id UUID PRIMARY KEY,\n  amount DECIMAL(10,2) NOT NULL,\n  type VARCHAR(50) NOT NULL\n);' },
    { name: 'contas_pagar', ddl: 'CREATE TABLE financeiro.contas_pagar (\n  id UUID PRIMARY KEY,\n  valor DECIMAL(10,2) NOT NULL,\n  vencimento DATE NOT NULL\n);' },
    { name: 'contas_receber', ddl: 'CREATE TABLE financeiro.contas_receber (\n  id UUID PRIMARY KEY,\n  valor DECIMAL(10,2) NOT NULL,\n  vencimento DATE NOT NULL\n);' },
  ],
  OPERACIONAL: [
    { name: 'produtos', ddl: 'CREATE TABLE inventario.produtos (\n  id UUID PRIMARY KEY,\n  nome VARCHAR(255) NOT NULL,\n  estoque_atual INTEGER DEFAULT 0\n);' },
    { name: 'movimentacoes_estoque', ddl: 'CREATE TABLE inventario.movimentacoes_estoque (\n  id UUID PRIMARY KEY,\n  produto_id UUID NOT NULL,\n  quantidade INTEGER NOT NULL\n);' },
  ],
  COMERCIAL: [
    { name: 'crm_leads', ddl: 'CREATE TABLE comercial.crm_leads (\n  id UUID PRIMARY KEY,\n  nome VARCHAR(255) NOT NULL,\n  status VARCHAR(50) DEFAULT \'novo\'\n);' },
    { name: 'campanhas_marketing', ddl: 'CREATE TABLE comercial.campanhas_marketing (\n  id UUID PRIMARY KEY,\n  titulo VARCHAR(255) NOT NULL,\n  ativa BOOLEAN DEFAULT true\n);' },
  ],
  CLINICO: [
    { name: 'teleconsultas', ddl: 'CREATE TABLE clinico.teleconsultas (\n  id UUID PRIMARY KEY,\n  patient_id UUID NOT NULL,\n  scheduled_at TIMESTAMPTZ NOT NULL\n);' },
    { name: 'tiss_guides', ddl: 'CREATE TABLE clinico.tiss_guides (\n  id UUID PRIMARY KEY,\n  numero_guia VARCHAR(100) NOT NULL\n);' },
  ],
  ADMINISTRATIVO: [
    { name: 'clinic_modules', ddl: 'CREATE TABLE configuracoes.clinic_modules (\n  id UUID PRIMARY KEY,\n  module_id VARCHAR(100) NOT NULL,\n  enabled BOOLEAN DEFAULT true\n);' },
    { name: 'audit_logs', ddl: 'CREATE TABLE administrativo.audit_logs (\n  id UUID PRIMARY KEY,\n  action VARCHAR(255) NOT NULL,\n  created_at TIMESTAMPTZ DEFAULT NOW()\n);' },
  ],
};
