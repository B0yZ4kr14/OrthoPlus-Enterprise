      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card className="border border-border bg-card hover:bg-muted transition-colors">
          ...
          <CardContent>
            ...
            <Button onClick={handleExport} variant="outline" className="w-full border-border text-foreground">
        ...
        <Card className="border border-border bg-card hover:bg-muted transition-colors">
          ...
          <CardContent>
            ...
            <Button onClick={handleImport} variant="outline" className="w-full border-border text-foreground">
              Importar Arquivo
            </Button>
          </CardContent>
        </Card>
      ...
      <div className="p-4 rounded-xl border border-warning/30 bg-warning/5">
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-4 w-full">
            ...
            <Button onClick={handleMigration} className="w-full bg-interactive hover:bg-interactive/90 text-white border-none">
