...
export function PedidosList({
  ...
  const getProdutoNome = (produtoId: string) => {
    return (
      produtos.find((p) => p.id === produtoId)?.nome || "Produto não encontrado"
    );
  };
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-semibold">
                    {getFornecedorNome(selectedPedido.fornecedorId)}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">
                ...
                {selectedPedido.dataPrevistaEntrega && (
                  <div>
                    ...
                    <p className="font-semibold">
                      {formatDate(selectedPedido.dataPrevistaEntrega)}
                    </p>
                  </div>
                )}
                <div>
                  ...
                  <Badge
                    className={getStatusConfig(selectedPedido.status)?.color}
                  >
                ...
                <div>
                  ...
                  <p className="font-semibold">
                    {selectedPedido.tipo === "AUTOMATICO"
                      ? "Automático"
                      : "Manual"}
                  </p>
                </div>
                    ...
                    <Card key={item.id || index} className="p-3">
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Quantidade: {item.quantidade} | Preço unitário:{" "}
