            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <Badge className={getPrioridadeColor(req.prioridade)}>
                  {
                    prioridadesRequisicao.find(
                      (p) => p.value === req.prioridade,
                    )?.label
                  }
                </Badge>
              </div>
              <p className="text-sm text-muted-foreground">
                Quantidade:{" "}
                <span className="font-medium">{req.quantidade}</span>
              </p>
              <p className="text-sm text-muted-foreground mt-1">{req.motivo}</p>
            </div>
