...
export const requisicaoSchema = z.object({
  ...
  status: z
    .enum(["PENDENTE", "APROVADA", "REJEITADA", "ENTREGUE"])
    .default("PENDENTE"),
...
export const fornecedorSchema = z.object({
  ...
  autoOrderConfig: z.unknown().optional(),
  createdAt: z.string().optional(),
});
...
export const tiposInventario = [
  {
    value: "GERAL",
    label: "Geral",
    description: "Contagem completa de todos os itens",
  },
  {
    value: "PARCIAL",
    label: "Parcial",
    description: "Contagem de itens específicos",
  },
  {
    value: "CICLICO",
    label: "Cíclico",
    description: "Contagem periódica por categoria",
  },
] as const;
...
export const pedidoConfigSchema = z.object({
  id: z.string().uuid().optional(),
  produtoId: z.string().uuid(),
  quantidadeReposicao: z
    .number()
    .min(1, "Quantidade de reposição deve ser maior que 0"),
