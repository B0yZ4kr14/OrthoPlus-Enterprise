        ...
        <Card className="p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold">
                {inventarios.reduce(
                  (acc, inv) => acc + (inv.divergenciasEncontradas || 0),
                  0,
                )}
              </p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold">
                R${" "}
                {inventarios
                  .reduce((acc, inv) => acc + (inv.valorDivergencias || 0), 0)
                  .toFixed(2)}
              </p>
            </div>
                ...
                <TableRow key={inventario.id}>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-24 h-2 bg-secondary rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${calculatePercentualContado(inventario)}%`,
                          }}
                        />
                      </div>
                  ...
                  <TableCell>
                    <Badge className={getStatusColor(inventario.status)}>
                      {
                        statusInventario.find(
                          (s) => s.value === inventario.status,
                        )?.label
                      }
                    </Badge>
                  </TableCell>
