...
export function RadiografiaComparison({
  ...
  const getTendenciaIcon = (tendencia: string) => {
    ...
    if (tendencia === "diminuiu" || tendencia === "melhorou")
      return TrendingDown;
    return Minus;
  };
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-sm font-medium">
                          {
                            tipoRadiografiaLabels[
                              analise1.tipo_radiografia as keyof typeof tipoRadiografiaLabels
                            ]
                          }
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-2xl font-bold text-primary">
                          {analise1.confidence_score
                            ? Math.round(analise1.confidence_score)
                            : 0}
                          %
                        </p>
                      </div>
                    ...
                    <div className="space-y-2">
                      <div>
                        ...
                        <p className="text-sm font-medium">
                          {
                            tipoRadiografiaLabels[
                              analise2.tipo_radiografia as keyof typeof tipoRadiografiaLabels
                            ]
                          }
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-2xl font-bold text-primary">
                          {analise2.confidence_score
                            ? Math.round(analise2.confidence_score)
                            : 0}
                          %
                        </p>
                      </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        {(() => {
                          const Icon = getTendenciaIcon(
                            comparacao.problemas.tendencia,
                          );
                          return (
                            <>
                              <Icon
                                className={`h-5 w-5 ${getTendenciaColor(comparacao.problemas.tendencia, true)}`}
                              />
                              <span
                      ...
                      <p className="text-xs text-muted-foreground">
                        {comparacao.problemas.percentual}%{" "}
                        {comparacao.problemas.tendencia}
                      </p>
                    </div>
                      ...
                      <div className="flex items-center gap-2">
                        {(() => {
                          ...
                          return (
                            <>
                              <Icon
                                className={`h-5 w-5 ${getTendenciaColor(comparacao.precisao.tendencia)}`}
                              />
                              <span
                      ...
                      <div className="text-sm">
                        {comparacao.problemas.valor < 0 && (
                          <p className="text-success font-medium">
                            ...
                            {Math.abs(comparacao.problemas.valor)} problema(s)
                            detectado(s).
                          </p>
                        )}
                        {comparacao.problemas.valor > 0 && (
                          <p className="text-destructive font-medium">
                            Atenção necessária: Aumento de{" "}
                            {comparacao.problemas.valor} problema(s)
                            detectado(s).
                          </p>
                        )}
                        {comparacao.problemas.valor === 0 && (
                          <p className="text-muted-foreground font-medium">
                            Situação estável: Número de problemas manteve-se
                            constante.
                          </p>
                        )}
                      </div>
