...
vi.mock(
  "@/modules/dentistas/components/dentista-form/DadosPessoaisTab",
  () => ({
    DadosPessoaisTab: () => (
      <div data-testid="tab-pessoais">Dados Pessoais Tab</div>
    ),
  }),
);

vi.mock(
  "@/modules/dentistas/components/dentista-form/DadosProfissionaisTab",
  () => ({
...
vi.mock(
  "@/modules/dentistas/components/dentista-form/ConfiguracoesTab",
  () => ({
    ConfiguracoesTab: () => (
      <div data-testid="tab-configuracoes">Configuracoes Tab</div>
    ),
  }),
);
