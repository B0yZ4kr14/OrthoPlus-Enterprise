      ...
      <div className="flex items-start justify-between">
        <div className="space-y-1">
          <div className="flex items-center gap-3">
            ...
            <Badge variant={getStatusColor(dentista.status)}>
              {dentista.status}
            </Badge>
          </div>
          <p className="text-sm text-muted-foreground">
            Cadastrado em{" "}
            {format(parseISO(dentista.createdAt!), "dd 'de' MMMM 'de' yyyy", {
              locale: ptBR,
            })}
          </p>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-muted-foreground">
              ...
              {dentista.endereco.estado}
            </p>
            <p className="text-sm text-muted-foreground">
              CEP: {dentista.endereco.cep}
            </p>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex items-center gap-4">
              <div>
                ...
                <p className="font-medium">
                  {dentista.horariosAtendimento.inicio} às{" "}
                  {dentista.horariosAtendimento.fim}
                </p>
              </div>
        ...
        <CardContent className="space-y-2 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium">
              {format(parseISO(dentista.createdAt!), "dd/MM/yyyy HH:mm", {
                locale: ptBR,
              })}
            </span>
          </div>
          <div className="flex justify-between">
            ...
            <span className="font-medium">
              {format(parseISO(dentista.updatedAt!), "dd/MM/yyyy HH:mm", {
                locale: ptBR,
              })}
            </span>
          </div>
