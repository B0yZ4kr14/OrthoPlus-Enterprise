...
export class Appointment {
  ...
  private validate(): void {
    ...
    if (
      this.props.durationMinutes <= 0 ||
      this.props.durationMinutes % 15 !== 0
    ) {
  ...
  get scheduledDatetime(): Date {
    return this.props.scheduledDatetime;
  }
  ...
  get endDatetime(): Date {
    return new Date(
      this.props.scheduledDatetime.getTime() +
        this.props.durationMinutes * 60000,
    );
  }
  ...
  confirm(): void {
    ...
    const twoHoursBeforeAppointment = new Date(
      this.props.scheduledDatetime.getTime() - 2 * 60 * 60 * 1000,
    );
