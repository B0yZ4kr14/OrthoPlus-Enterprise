    ...
    <div className="space-y-4" data-testid="calendar-view">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Button type="button" variant="outline" size="icon" onClick={previousWeek} aria-label="Semana anterior">
            <ChevronLeft className="h-4 w-4" />
          </Button>
          <Button type="button" variant="outline" onClick={goToToday}>
            Hoje
          </Button>
          <Button type="button" variant="outline" size="icon" onClick={nextWeek} aria-label="Próxima semana">
