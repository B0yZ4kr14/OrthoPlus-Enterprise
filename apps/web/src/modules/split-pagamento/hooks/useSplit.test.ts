...
describe("useSplit", () => {
  ...
  describe("data fetching", () => {
    it("should fetch configs, transacoes, and comissoes on mount", async () => {
      ...
      expect(mockGet).toHaveBeenNthCalledWith(1, "/split/config", {
        params: { clinic_id: mockAuthValue.selectedClinic, sort: "created_at.desc" },
      })
      expect(mockGet).toHaveBeenNthCalledWith(2, "/split/transacoes", {
        params: { clinic_id: mockAuthValue.selectedClinic, sort: "created_at.desc" },
      })
      expect(mockGet).toHaveBeenNthCalledWith(3, "/split/comissoes", {
        params: { clinic_id: mockAuthValue.selectedClinic, sort: "mes_referencia.desc" },
      })
    ...
    it("should show error toast when fetch fails", async () => {
      ...
      expect(toast.error).toHaveBeenCalledWith("Erro ao carregar dados de split")
    })
  })
  ...
  describe("createConfig", () => {
    ...
    it("should create config and reload data on success", async () => {
      ...
      await act(async () => {
        await result.current.createConfig({ percentual_split: 50, dentist_id: "dent-1" })
      })
      ...
      expect(toast.success).toHaveBeenCalledWith("Configuração de split criada com sucesso!")
    })
    ...
    it("should show error toast when create fails", async () => {
      ...
      expect(toast.error).toHaveBeenCalledWith("Erro ao criar configuração de split")
    })
  ...
  describe("updateConfig", () => {
    ...
    it("should update config and reload data on success", async () => {
      ...
      expect(mockPut).toHaveBeenCalledWith("/split/config/cfg-1", { percentual_split: 60 })
      expect(toast.success).toHaveBeenCalledWith("Configuração de split atualizada com sucesso!")
    })
    ...
    it("should show error toast when update fails", async () => {
      ...
      expect(toast.error).toHaveBeenCalledWith("Erro ao atualizar configuração de split")
    })
  ...
  describe("deleteConfig", () => {
    ...
    it("should delete config and reload data on success", async () => {
      ...
      expect(toast.success).toHaveBeenCalledWith("Configuração de split excluída com sucesso!")
    })
    ...
    it("should show error toast when delete fails", async () => {
      ...
      expect(toast.error).toHaveBeenCalledWith("Erro ao excluir configuração de split")
    })
