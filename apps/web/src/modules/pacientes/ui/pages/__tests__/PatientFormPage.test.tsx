...
const authState: { clinicId: string | null; user: { id: string } | null } = { clinicId: "clinic-1", user: { id: "user-1" } }
...
describe("PatientFormPage", () => {
  ...
  it("should update existing patient on form submit", async () => {
    ...
    await waitFor(() => {
      expect(mockPut).toHaveBeenCalledWith("/pacientes/patient-1", expect.any(Object))
    })
