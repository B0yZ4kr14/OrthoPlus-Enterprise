  ...
  const getChanges = () => {
    ...
    ALL_TEETH.forEach((num) => {
      ...
      Object.keys(tooth1.surfaces).forEach((surface) => {
        if (
          tooth1.surfaces[surface as keyof typeof tooth1.surfaces] !==
        ...
        <CardContent className="py-12">
          <div className="text-center text-muted-foreground">
            ...
            <p className="text-sm mt-1">
              Use o botão "Comparar" no histórico para selecionar
            </p>
          </div>
        </CardContent>
      </Card>
                          ...
                          {change.surfacesChanged.map((surface) => (
                            ...
                            >
                              <span className="font-medium min-w-[100px]">
                                {
                                  TOOTH_SURFACE_LABELS[
                                    surface as keyof typeof TOOTH_SURFACE_LABELS
                                  ]
                                }
                                :
                              </span>
                              <Badge variant="outline" className="text-xs">
                                {
                                  TOOTH_STATUS_LABELS[
                                    change.before.surfaces[
                                      surface as keyof typeof change.before.surfaces
                                    ]
                                  ]
                                }
                              </Badge>
                              ...
                              <Badge variant="default" className="text-xs">
                                {
                                  TOOTH_STATUS_LABELS[
                                    change.after.surfaces[
                                      surface as keyof typeof change.after.surfaces
                                    ]
                                  ]
                                }
                              </Badge>
