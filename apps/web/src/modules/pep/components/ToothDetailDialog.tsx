        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-3">
              {(Object.keys(TOOTH_SURFACE_LABELS) as ToothSurface[]).map(
                (surface) => (
                  <div
                    key={surface}
                    ...
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        ...
                        <Badge
                          ...
                          style={{
                            backgroundColor:
                              TOOTH_STATUS_COLORS[tooth.surfaces[surface]],
                            color:
                              tooth.surfaces[surface] === "extraido"
                                ? "#ffffff"
                                : "#000000",
                          }}
                        >
          ...
          <div className="text-sm text-muted-foreground">
            Última atualização:{" "}
            {new Date(tooth.updatedAt).toLocaleString("pt-BR")}
          </div>
        </div>
