...
export function useAssinaturaICP() {
  ...
  const hasAccess = useMemo(
    () => hasModuleAccess("ASSINATURA_ICP"),
    [hasModuleAccess],
  );
  ...
  const documentosRecentes: DocumentoAssinado[] = useMemo(
    () => [
      ...
      {
        name: "Termo de Consentimento - Maria",
        type: "Termo",
        date: "Hoje, 11:20",
        signers: 1,
      },
      {
        name: "Orçamento - Carlos Souza",
        type: "Orçamento",
        date: "Ontem, 16:45",
        signers: 2,
      },
  ...
  const solicitacoesPendentes: SolicitacaoPendente[] = useMemo(
    () => [
      {
        name: "Contrato de Tratamento - Ana Lima",
  ...
  const validacoes: Validacao[] = useMemo(
    () => [
      {
        doc: "Contrato_Silva_2025.pdf",
        result: "Válido",
        date: "Hoje, 15:30",
        details: "Todas as assinaturas verificadas",
      },
      {
        doc: "Termo_Consentimento.pdf",
        result: "Válido",
        date: "Ontem, 10:20",
        details: "1 assinatura verificada",
      },
    ],
    [],
  );
