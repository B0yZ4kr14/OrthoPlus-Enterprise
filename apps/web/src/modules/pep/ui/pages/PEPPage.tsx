...
export default function PEPPage() {
  ...
  const handleCreateTreatmentsFromAI = async (suggestions: unknown[]) => {
    if (!user) {
      toast({
        title: "Erro",
        ...
        <TabsContent value="tratamentos">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <div className="flex gap-2">
                <Dialog
                  open={isPrescricaoDialogOpen}
                  onOpenChange={setIsPrescricaoDialogOpen}
                >
                  <DialogTrigger asChild>
                ...
                <Dialog
                  ...
                  onOpenChange={setIsReceitaDialogOpen}
                >
                  <DialogTrigger asChild>
                    <Button variant="outline">
                      <Plus className="h-4 w-4 mr-2" />
                ...
                <Dialog
                  open={isTratamentoDialogOpen}
                  onOpenChange={setIsTratamentoDialogOpen}
                >
                  <DialogTrigger asChild>
                    <Button>
                      <Plus className="h-4 w-4 mr-2" />
