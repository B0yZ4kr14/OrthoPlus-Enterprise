...
export default function CRMFunil() {
  ...
  const leads = [
    ...
    },
    {
      id: "3",
      nome: "Beatriz Lima",
      status_funil: "ORCAMENTO_ENVIADO",
      score_qualidade: 90,
      temperatura: "QUENTE",
      valor_estimado: 8000,
    },
  ...
  const taxaConversao = (
    (funil.GANHO / (funil.GANHO + funil.PERDIDO)) *
    100
  ).toFixed(1);
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="text-2xl font-bold">
                {Object.values(funil).reduce((a, b) => a + b, 0)}
              </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="text-2xl font-bold">
                R${" "}
                {(
                  leads.reduce((sum, l) => sum + l.valor_estimado, 0) / 1000
                ).toFixed(1)}
                k
              </div>
              <div className="text-sm text-muted-foreground">
                ...
                >
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div
                        className={`w-2 h-2 rounded-full ${getTemperaturaColor(lead.temperatura)}`}
                      />
                      <Badge variant="outline">
                        {lead.status_funil.replace("_", " ")}
                      </Badge>
                    </div>
