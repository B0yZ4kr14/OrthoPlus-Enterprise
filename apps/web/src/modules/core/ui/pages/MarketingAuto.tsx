        ...
        <TabsContent value="templates" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Criar e gerenciar templates reutilizáveis com variáveis
                dinâmicas
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="flex gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground">
                Configure uma vez e deixe o sistema trabalhar por você. Envios
                automáticos baseados em gatilhos, segmentação avançada e
                personalização de mensagens para maximizar o engajamento.
              </p>
            </div>
          </div>
        </CardContent>
