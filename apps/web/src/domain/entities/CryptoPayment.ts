...
export class CryptoConfig {
  ...
  get btcpayServerUrl() {
    return this.props.btcpayServerUrl;
  }
  get isActive() {
...
export class CryptoTransaction {
  ...
  static create(
    props: Omit<
      CryptoTransactionProps,
      "id" | "status" | "confirmations" | "createdAt"
    >,
  ): CryptoTransaction {
    if (
      !props.clinicId ||
      !props.btcpayInvoiceId ||
      !props.btcpayCheckoutLink
    ) {
      throw new Error("Dados obrigatórios não fornecidos");
    }
  ...
  get btcpayInvoiceId() {
    return this.props.btcpayInvoiceId;
  }
  get btcpayCheckoutLink() {
    return this.props.btcpayCheckoutLink;
  }
  get amountBrl() {
...
export class CryptoWallet {
  ...
  get balanceSats() {
    return this.props.balanceSats;
  }
  get balanceBrl() {
    return this.props.balanceBrl;
  }
  get cryptocurrency() {
    return this.props.cryptocurrency;
  }
