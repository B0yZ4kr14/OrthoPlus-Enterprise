...
argument-hint: '[slug|task-id] [--base <ref>] [--full] [--micro] [--paths <glob,...>]
  [--review-model <model[:axis]@axis>]'
allowed-tools:
- Read
- Write
- Glob
...
<!-- Extension: multi-model-review -->
<!-- Config: .specify/extensions/multi-model-review/ -->
