...
- IAR-FR-001: Dentists MUST be able to upload radiograph images ...
- IAR-FR-002: The system MUST verify active LGPD patient consent...
- IAR-FR-003: Uploaded images MUST have DICOM/EXIF metadata stri...
- IAR-FR-004: The system MUST call an AI vision model to analyze...
- IAR-FR-005: AI analysis results MUST be encrypted at rest befo...
- IAR-FR-006: Dentists MUST be able to review AI findings, add o...
- IAR-FR-007: The system MUST maintain an immutable audit trail ...
- IAR-FR-008: Clinics MUST be able to register, check, and revok...
- IAR-FR-009: Dentists MUST be able to view aggregated insights ...
- IAR-FR-010: Dentists MUST be able to compare multiple radiogra...
- IAR-FR-011: The system MUST support exporting comparative anal...
- IAR-FR-012: The entire feature MUST be gated by an environment...
