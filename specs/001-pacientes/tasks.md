...
**Input**: Design documents from `/specs/001-pacientes//`
...
- [ ] T201 [P] Update/add React Query hooks for `pacientes` endpoints
- [ ] T202 [P] Create/update reusable components in `pacientes/ui/components/`
...
#### US1: Cadastro de Novo Paciente (Priority: P1) 🎯 MVP
...
#### US2: Busca Rápida de Paciente (Priority: P1) 🎯 MVP

**Goal**: Implement busca rápida de paciente per spec Story 2

**Independent Test**: Verify via UI + API integration

- [ ] T310 [P] [US2] UI: Create main page/component for Busca Rápida de Paciente
...
- [ ] T320 [P] [US3] UI: Create main page/component for Timeline do Paciente
...
- [ ] T330 [P] [US4] UI: Create main page/component for Portal do Paciente
...
- [ ] T401 Handle edge case: CPF Inválido — Mensagem de erro específica: CPF inválido. Verifique os dígitos.
- [ ] T402 Handle edge case: Paciente Sem CPF (Estrangeiro) — Campo CPF opcional, passaporte como alternativa. Alerta visual mas não bloqueante.
- [ ] T403 Handle edge case: CEP Não Encontrado — Campos de endereço ficam editáveis manualmente. Toast informativo.
- [ ] T404 Handle edge case: Upload de Foto Muito Grande — Rejeição com mensagem clara. Sugestão de compressão.
...
- Brownfield: extend existing `pacientes` module, don't rebuild
