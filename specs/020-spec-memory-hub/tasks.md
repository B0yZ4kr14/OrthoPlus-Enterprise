...
- [X] T050 [P] Implement API key validation on startup in `backend/src/modules/memory_hub/infrastructure/ApiKeyValidator.ts`
...
- [X] T051 [P] Implement API key hot-swap in `backend/src/modules/memory_hub/infrastructure/ApiKeyHotSwap.ts`
...
- [X] T052 [P] Implement encrypted key storage in `backend/src/modules/memory_hub/infrastructure/SecureConfigStore.ts`
...
- [X] T054 [P] Inject request ID into embedding calls in `backend/src/modules/memory_hub/infrastructure/OllamaEmbeddingClient.ts`
