# Tasks: Catálogo de Procedimentos

**Input**: Design documents from `/specs/007-procedimentos//`
...
- [ ] T001 Audit existing `procedimentos` backend module (Prisma models, controllers, routes)
- [ ] T002 Audit existing `procedimentos` frontend module (components, hooks, pages)
...
- [ ] T101 [P] Backend: CRUD de Procedimentos — Gestão completa do catálogo de procedimentos odontológicos.
- [ ] T102 [P] Backend: Tabela de Preços Multipla — Preços por convênio e particular.
- [ ] T103 [P] Backend: Associação Dentista-Procedimento — Define quem pode executar o quê.
- [ ] T104 [P] Prisma schema update + migration generation
- [ ] T105 [P] Extend `procedimentosService.ts` with new operations
- [ ] T106 [P] Extend `procedimentosController.ts` with new endpoints
...
- [ ] T201 [P] Update/add React Query hooks for `procedimentos` endpoints
- [ ] T202 [P] Create/update reusable components in `procedimentos/ui/components/`
...
#### US1: Cadastrar Procedimento (Priority: P1) 🎯 MVP

**Goal**: Implement cadastrar procedimento per spec Story 1

**Independent Test**: Verify via UI + API integration

- [ ] T300 [P] [US1] UI: Create main page/component for Cadastrar Procedimento
...
#### US2: Tabela de Preços (Priority: P1) 🎯 MVP

**Goal**: Implement tabela de preços per spec Story 2

**Independent Test**: Verify via UI + API integration

- [ ] T310 [P] [US2] UI: Create main page/component for Tabela de Preços
...
#### US3: Associação a Dentistas (Priority: P2) 🎯 MVP

**Goal**: Implement associação a dentistas per spec Story 3

**Independent Test**: Verify via UI + API integration

- [ ] T320 [P] [US3] UI: Create main page/component for Associação a Dentistas
...
#### US4: Categorização e Filtros (Priority: P3) 🎯 MVP

**Goal**: Implement categorização e filtros per spec Story 4

**Independent Test**: Verify via UI + API integration

- [ ] T330 [P] [US4] UI: Create main page/component for Categorização e Filtros
...
- Brownfield: extend existing `procedimentos` module, don't rebuild
