...
|----|-----------|-------------|
| BID-SC-1 | CRUD de dashboards funcional | Testes unitários passam |
| BID-SC-2 | CRUD de widgets funcional | Testes unitários passam |
| BID-SC-3 | Isolamento por clínica | Todas as queries filtram clinic_id |
