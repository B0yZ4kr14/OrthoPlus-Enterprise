# Tasks: Integração TISS e Convênios

**Input**: Design documents from `/specs/012-tiss//`
...
- [ ] T001 Audit existing `tiss` backend module (Prisma models, controllers, routes)
- [ ] T002 Audit existing `tiss` frontend module (components, hooks, pages)
...
- [ ] T101 [P] Backend: Cadastro de Convênios — Gestão de operadoras de saúde.
- [ ] T102 [P] Backend: Guia TISS — Geração e envio de guias de autorização.
- [ ] T103 [P] Backend: Status de Autorização — Consulta e acompanhamento.
- [ ] T104 [P] Prisma schema update + migration generation
- [ ] T105 [P] Extend `tissService.ts` with new operations
- [ ] T106 [P] Extend `tissController.ts` with new endpoints
...
- [ ] T201 [P] Update/add React Query hooks for `tiss` endpoints
- [ ] T202 [P] Create/update reusable components in `tiss/ui/components/`
...
#### US1: Cadastrar Convênio (Priority: P1) 🎯 MVP

**Goal**: Implement cadastrar convênio per spec Story 1

**Independent Test**: Verify via UI + API integration

- [ ] T300 [P] [US1] UI: Create main page/component for Cadastrar Convênio
...
#### US2: Solicitar Autorização (GUIA TISS) (Priority: P1) 🎯 MVP

**Goal**: Implement solicitar autorização (guia tiss) per spec Story 2

**Independent Test**: Verify via UI + API integration

- [ ] T310 [P] [US2] UI: Create main page/component for Solicitar Autorização (GUIA TISS)
...
#### US3: Consultar Status de Autorização (Priority: P2) 🎯 MVP

**Goal**: Implement consultar status de autorização per spec Story 3

**Independent Test**: Verify via UI + API integration

- [ ] T320 [P] [US3] UI: Create main page/component for Consultar Status de Autorização
...
#### US4: Faturamento de Glosas (Priority: P3) 🎯 MVP

**Goal**: Implement faturamento de glosas per spec Story 4

**Independent Test**: Verify via UI + API integration

- [ ] T330 [P] [US4] UI: Create main page/component for Faturamento de Glosas
...
- Brownfield: extend existing `tiss` module, don't rebuild
