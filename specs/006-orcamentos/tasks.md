...
**Input**: Design documents from `/specs/006-orcamentos//`
...
- [ ] T001 Audit existing `orcamentos` backend module (Prisma models, controllers, routes)
- [ ] T002 Audit existing `orcamentos` frontend module (components, hooks, pages)
...
- [ ] T106 [P] Extend `orcamentosController.ts` with new endpoints
...
#### US1: Criar Orçamento (Priority: P1) 🎯 MVP

**Goal**: Implement criar orçamento per spec Story 1

**Independent Test**: Verify via UI + API integration

- [ ] T300 [P] [US1] UI: Create main page/component for Criar Orçamento
...
#### US2: Aprovação de Orçamento (Priority: P1) 🎯 MVP

**Goal**: Implement aprovação de orçamento per spec Story 2

**Independent Test**: Verify via UI + API integration

- [ ] T310 [P] [US2] UI: Create main page/component for Aprovação de Orçamento
...
#### US3: Acompanhamento de Orçamentos (Priority: P2) 🎯 MVP

**Goal**: Implement acompanhamento de orçamentos per spec Story 3

**Independent Test**: Verify via UI + API integration

- [ ] T320 [P] [US3] UI: Create main page/component for Acompanhamento de Orçamentos
...
#### US4: Revisão de Orçamento (Priority: P3) 🎯 MVP

**Goal**: Implement revisão de orçamento per spec Story 4

**Independent Test**: Verify via UI + API integration

- [ ] T330 [P] [US4] UI: Create main page/component for Revisão de Orçamento
...
- Brownfield: extend existing `orcamentos` module, don't rebuild
