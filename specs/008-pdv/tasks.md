# Tasks: Ponto de Venda (PDV)

**Input**: Design documents from `/specs/008-pdv//`
...
- [ ] T001 Audit existing `pdv` backend module (Prisma models, controllers, routes)
- [ ] T002 Audit existing `pdv` frontend module (components, hooks, pages)
...
- [ ] T101 [P] Backend: CRUD de Vendas — Registro completo de transações de venda.
- [ ] T102 [P] Backend: Múltiplas Formas de Pagamento — Pagamento misto e parcelado.
- [ ] T103 [P] Backend: Controle de Caixa — Abertura, movimentação e fechamento.
- [ ] T104 [P] Prisma schema update + migration generation
- [ ] T105 [P] Extend `pdvService.ts` with new operations
- [ ] T106 [P] Extend `pdvController.ts` with new endpoints
...
- [ ] T201 [P] Update/add React Query hooks for `pdv` endpoints
- [ ] T202 [P] Create/update reusable components in `pdv/ui/components/`
...
#### US2: Fechamento de Caixa (Priority: P1) 🎯 MVP

**Goal**: Implement fechamento de caixa per spec Story 2

**Independent Test**: Verify via UI + API integration

- [ ] T310 [P] [US2] UI: Create main page/component for Fechamento de Caixa
...
#### US3: Controle de Estoque em Venda (Priority: P2) 🎯 MVP

**Goal**: Implement controle de estoque em venda per spec Story 3

**Independent Test**: Verify via UI + API integration

- [ ] T320 [P] [US3] UI: Create main page/component for Controle de Estoque em Venda
...
#### US4: Relatório de Vendas (Priority: P3) 🎯 MVP

**Goal**: Implement relatório de vendas per spec Story 4

**Independent Test**: Verify via UI + API integration

- [ ] T330 [P] [US4] UI: Create main page/component for Relatório de Vendas
...
- Brownfield: extend existing `pdv` module, don't rebuild
