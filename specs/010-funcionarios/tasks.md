# Tasks: Gestão de Funcionários

**Input**: Design documents from `/specs/010-funcionarios//`
...
- [ ] T001 Audit existing `funcionarios` backend module (Prisma models, controllers, routes)
- [ ] T002 Audit existing `funcionarios` frontend module (components, hooks, pages)
...
- [ ] T101 [P] Backend: CRUD de Funcionários — Gestão completa de colaboradores.
- [ ] T102 [P] Backend: Controle de Ponto — Registro de jornada.
- [ ] T103 [P] Backend: Escala de Trabalho — Planejamento de folgas e turnos.
- [ ] T104 [P] Prisma schema update + migration generation
- [ ] T105 [P] Extend `funcionariosService.ts` with new operations
- [ ] T106 [P] Extend `funcionariosController.ts` with new endpoints
...
- [ ] T201 [P] Update/add React Query hooks for `funcionarios` endpoints
- [ ] T202 [P] Create/update reusable components in `funcionarios/ui/components/`
...
#### US1: Cadastro de Funcionário (Priority: P1) 🎯 MVP

**Goal**: Implement cadastro de funcionário per spec Story 1

**Independent Test**: Verify via UI + API integration

- [ ] T300 [P] [US1] UI: Create main page/component for Cadastro de Funcionário
...
#### US2: Controle de Ponto (Priority: P1) 🎯 MVP

**Goal**: Implement controle de ponto per spec Story 2

**Independent Test**: Verify via UI + API integration

- [ ] T310 [P] [US2] UI: Create main page/component for Controle de Ponto
...
#### US3: Escalas e Folgas (Priority: P2) 🎯 MVP

**Goal**: Implement escalas e folgas per spec Story 3

**Independent Test**: Verify via UI + API integration

- [ ] T320 [P] [US3] UI: Create main page/component for Escalas e Folgas
...
#### US4: Comissões (Priority: P3) 🎯 MVP

**Goal**: Implement comissões per spec Story 4

**Independent Test**: Verify via UI + API integration

- [ ] T330 [P] [US4] UI: Create main page/component for Comissões
...
- Brownfield: extend existing `funcionarios` module, don't rebuild
