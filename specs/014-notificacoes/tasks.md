# Tasks: Sistema de Notificações

**Input**: Design documents from `/specs/014-notificacoes//`
...
- [ ] T001 Audit existing `notifications` backend module (Prisma models, controllers, routes)
- [ ] T002 Audit existing `notifications` frontend module (components, hooks, pages)
...
- [ ] T101 [P] Backend: Envio Multi-Canal — Notificações via WhatsApp, SMS e email.
- [ ] T102 [P] Backend: Confirmação de Agendamento — Lembrete e confirmação de consulta.
- [ ] T103 [P] Backend: Alertas de Recall — Lembrete de retorno programado.
- [ ] T104 [P] Prisma schema update + migration generation
- [ ] T105 [P] Extend `notificationsService.ts` with new operations
- [ ] T106 [P] Extend `notificationsController.ts` with new endpoints
...
- [ ] T201 [P] Update/add React Query hooks for `notifications` endpoints
- [ ] T202 [P] Create/update reusable components in `notifications/ui/components/`
...
#### US1: Notificação de Agendamento (Priority: P1) 🎯 MVP

**Goal**: Implement notificação de agendamento per spec Story 1

**Independent Test**: Verify via UI + API integration

- [ ] T300 [P] [US1] UI: Create main page/component for Notificação de Agendamento
...
#### US2: Alerta de Recall (Priority: P1) 🎯 MVP

**Goal**: Implement alerta de recall per spec Story 2

**Independent Test**: Verify via UI + API integration

- [ ] T310 [P] [US2] UI: Create main page/component for Alerta de Recall
...
#### US3: Notificações Internas (Priority: P2) 🎯 MVP

**Goal**: Implement notificações internas per spec Story 3

**Independent Test**: Verify via UI + API integration

- [ ] T320 [P] [US3] UI: Create main page/component for Notificações Internas
...
#### US4: Template Builder (Priority: P3) 🎯 MVP

**Goal**: Implement template builder per spec Story 4

**Independent Test**: Verify via UI + API integration

- [ ] T330 [P] [US4] UI: Create main page/component for Template Builder
...
- Brownfield: extend existing `notifications` module, don't rebuild
