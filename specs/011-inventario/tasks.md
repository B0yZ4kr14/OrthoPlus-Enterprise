# Tasks: Gestão de Inventário

**Input**: Design documents from `/specs/011-inventario//`
...
- [ ] T001 Audit existing `inventario` backend module (Prisma models, controllers, routes)
- [ ] T002 Audit existing `inventario` frontend module (components, hooks, pages)
...
- [ ] T101 [P] Backend: CRUD de Produtos — Catálogo de materiais e produtos.
- [ ] T102 [P] Backend: Movimentações — Entradas e saídas com rastreabilidade.
- [ ] T103 [P] Backend: Alertas — Notificações de estoque crítico.
- [ ] T104 [P] Prisma schema update + migration generation
- [ ] T105 [P] Extend `inventarioService.ts` with new operations
- [ ] T106 [P] Extend `inventarioController.ts` with new endpoints
...
- [ ] T201 [P] Update/add React Query hooks for `inventario` endpoints
- [ ] T202 [P] Create/update reusable components in `inventario/ui/components/`
...
#### US1: Cadastro de Produto (Priority: P1) 🎯 MVP

**Goal**: Implement cadastro de produto per spec Story 1

**Independent Test**: Verify via UI + API integration

- [ ] T300 [P] [US1] UI: Create main page/component for Cadastro de Produto
...
#### US2: Entrada e Saída (Priority: P1) 🎯 MVP

**Goal**: Implement entrada e saída per spec Story 2

**Independent Test**: Verify via UI + API integration

- [ ] T310 [P] [US2] UI: Create main page/component for Entrada e Saída
...
#### US3: Alertas de Estoque (Priority: P2) 🎯 MVP

**Goal**: Implement alertas de estoque per spec Story 3

**Independent Test**: Verify via UI + API integration

- [ ] T320 [P] [US3] UI: Create main page/component for Alertas de Estoque
...
#### US4: Inventário Físico (Priority: P3) 🎯 MVP

**Goal**: Implement inventário físico per spec Story 4

**Independent Test**: Verify via UI + API integration

- [ ] T330 [P] [US4] UI: Create main page/component for Inventário Físico
...
- Brownfield: extend existing `inventario` module, don't rebuild
