# Tasks: CRM e Marketing

**Input**: Design documents from `/specs/013-crm//`
...
- [ ] T001 Audit existing `crm` backend module (Prisma models, controllers, routes)
- [ ] T002 Audit existing `crm` frontend module (components, hooks, pages)
...
- [ ] T101 [P] Backend: Campanhas — Criação e execução de campanhas de marketing.
- [ ] T102 [P] Backend: Automações — Fluxos automáticos baseados em eventos.
- [ ] T103 [P] Backend: Funil de Conversão — Visualização do journey do paciente.
- [ ] T104 [P] Prisma schema update + migration generation
- [ ] T105 [P] Extend `crmService.ts` with new operations
- [ ] T106 [P] Extend `crmController.ts` with new endpoints
...
- [ ] T201 [P] Update/add React Query hooks for `crm` endpoints
- [ ] T202 [P] Create/update reusable components in `crm/ui/components/`
...
#### US1: Campanha de Recall (Priority: P1) 🎯 MVP

**Goal**: Implement campanha de recall per spec Story 1

**Independent Test**: Verify via UI + API integration

- [ ] T300 [P] [US1] UI: Create main page/component for Campanha de Recall
...
#### US2: Aniversariantes (Priority: P1) 🎯 MVP

**Goal**: Implement aniversariantes per spec Story 2

**Independent Test**: Verify via UI + API integration

- [ ] T310 [P] [US2] UI: Create main page/component for Aniversariantes
...
#### US3: Funil de Conversão (Priority: P2) 🎯 MVP

**Goal**: Implement funil de conversão per spec Story 3

**Independent Test**: Verify via UI + API integration

- [ ] T320 [P] [US3] UI: Create main page/component for Funil de Conversão
...
#### US4: NPS e Pesquisa (Priority: P3) 🎯 MVP

**Goal**: Implement nps e pesquisa per spec Story 4

**Independent Test**: Verify via UI + API integration

- [ ] T330 [P] [US4] UI: Create main page/component for NPS e Pesquisa
...
- Brownfield: extend existing `crm` module, don't rebuild
