import {
  Contrato,
  ItemContrato,
} from "../../src/modules/contratos/domain/entities/Contrato";

const makeItemContrato = (
  overrides: Partial<ItemContrato> = {},
): ItemContrato => ({
...
describe("Contrato Domain Entity", () => {
  ...
  describe("assinar", () => {
    ...
    it("sets dataAssinatura to current date", () => {
      ...
      expect(contrato.dataAssinatura!.getTime()).toBeGreaterThanOrEqual(
        before.getTime(),
      );
    });
  });
