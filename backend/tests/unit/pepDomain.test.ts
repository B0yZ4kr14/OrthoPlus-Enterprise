import {
  Prontuario,
  ProntuarioProps,
} from "../../src/modules/pep/domain/entities/Prontuario";
...
describe("Prontuario Domain Entity", () => {
  ...
  describe("adicionarAnexo", () => {
    ...
    it("allows adding anexos to signed prontuarios", () => {
      ...
      // Should not throw
      expect(() =>
        pront.adicionarAnexo("https://storage.example.com/extra.pdf"),
      ).not.toThrow();
    });
  });
  ...
  describe("workflow scenarios", () => {
    it("supports complete workflow: create -> update fields -> add anexos -> sign", () => {
      ...
      // Update plano
      pront.atualizarPlanoDeTratamento(
        "1. Restauração com resina\n2. Polimento",
      );
