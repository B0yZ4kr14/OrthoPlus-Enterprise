...
describe('CRMController', () => {
  ...
  describe('createLead', () => {
    ...
    it('returns 400 on validation error (invalid email)', async () => {
      const req = mockReq({ name: 'Lead', email: 'not-an-email' }, {}, {}, { clinicId: 'clinic-1' })
      const res = mockRes()
  ...
  describe('updateLead', () => {
    ...
    it('returns 404 when lead does not exist', async () => {
      ...
      const req = mockReq({ name: 'Updated' }, { id: 'lead-x' }, {}, { clinicId: 'clinic-1' })
      const res = mockRes()
    ...
    it('returns 400 on validation error (invalid email)', async () => {
      ...
      const req = mockReq({ email: 'invalid' }, { id: 'lead-1' }, {}, { clinicId: 'clinic-1' })
      const res = mockRes()
    ...
    it('updates and returns lead on valid input', async () => {
      ...
      const req = mockReq({ name: 'New' }, { id: 'lead-1' }, {}, { clinicId: 'clinic-1' })
      const res = mockRes()
