...
const makeProduto = (
  overrides: Partial<Parameters<typeof Produto.create>[0]> = {},
): Produto => {
...
describe("Produto Domain Entity", () => {
  ...
  describe("adicionarEstoque", () => {
    ...
    it("throws when quantidade is zero", () => {
      const p = makeProduto();
      expect(() => p.adicionarEstoque(0)).toThrow(
    ...
    it("throws when quantidade is negative", () => {
      const p = makeProduto();
      expect(() => p.adicionarEstoque(-3)).toThrow(
        "Quantidade deve ser positiva",
      );
    });
  });
  ...
  describe("removerEstoque", () => {
    ...
    it("throws when quantidade is negative", () => {
      const p = makeProduto();
      expect(() => p.removerEstoque(-1)).toThrow(
        "Quantidade deve ser positiva",
      );
    });
  ...
  describe("ajustarEstoque", () => {
    ...
    it("throws when novaQuantidade is negative", () => {
      const p = makeProduto();
      expect(() => p.ajustarEstoque(-1)).toThrow(
