...
export class PatientStatus {
  ...
  static fromCode(code: string): PatientStatus {
    ...
    > = {
      ABANDONO: {
        name: "Abandono",
        desc: "Paciente abandonou o tratamento",
        color: "#DC2626",
      },
      AFASTAMENTO_TEMPORARIO: {
        name: "Afastamento Temporário",
        desc: "Temporariamente afastado",
        color: "#F59E0B",
      },
      A_PROTESTAR: {
        name: "A Protestar",
      ...
      CANCELADO: {
        name: "Cancelado",
        desc: "Tratamento cancelado",
        color: "#991B1B",
      },
      CONTENCAO: {
        name: "Contenção",
        desc: "Fase de contenção",
        color: "#3B82F6",
      },
      CONCLUIDO: {
        name: "Concluído",
        desc: "Tratamento concluído",
        color: "#10B981",
      },
      ERUPCAO: {
        name: "Erupção",
        desc: "Aguardando erupção dentária",
        color: "#8B5CF6",
      },
      INATIVO: { name: "Inativo", desc: "Paciente inativo", color: "#6B7280" },
      MIGRADO: {
        name: "Migrado",
        desc: "Migrado de outro sistema",
        color: "#14B8A6",
      },
      PROSPECT: { name: "Prospect", desc: "Lead potencial", color: "#F97316" },
      PROTESTO: {
        name: "Protesto",
        desc: "Protestado juridicamente",
        color: "#7C2D12",
      },
      RESPONSAVEL: {
        name: "Responsável",
        desc: "Responsável de outro paciente",
        color: "#0EA5E9",
      },
      TRATAMENTO: {
        name: "Em Tratamento",
        desc: "Tratamento em andamento",
        color: "#22C55E",
      },
      TRANSFERENCIA: {
        name: "Transferência",
        desc: "Em transferência",
        color: "#A855F7",
      },
    };
