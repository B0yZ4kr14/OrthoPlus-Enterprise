...
export interface IOrcamentoRepository {
  listOrcamentos(clinicId: string, filters?: { patient_id?: string; status?: string }): Promise<orcamentos[]>
  ...
  updateOrcamento(id: string, data: Prisma.orcamentosUpdateInput): Promise<orcamentos>
