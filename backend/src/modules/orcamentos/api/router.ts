...
router.patch("/:id/rejeitar", asyncHandler(controller.rejeitar.bind(controller)));

// Items
router.get("/:orcamento_id/items", asyncHandler(controller.listItems.bind(controller)));
router.post("/:orcamento_id/items", asyncHandler(controller.addItem.bind(controller)));
