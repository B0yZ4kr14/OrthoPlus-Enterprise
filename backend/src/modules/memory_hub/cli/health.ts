...
const coverage = totalDocs > 0 ? Math.round((recentlyIndexed / totalDocs) * 100) : 0
...
console.log(`  📅 Last scan:         ${allDocs[0]?.lastIndexed ? new Date(allDocs[0].lastIndexed).toLocaleString() : "N/A"}`)
