export interface INotificationRepository {
  // ── Appointments ──────────────────────────────────────────────────────
  findUpcomingAppointments(tomorrowStart: string, tomorrowEnd: string): Promise<any[]>
  ...
  findCryptoAlertsByCascadeGroup(cascadeGroupId: string, cascadeOrder: number): Promise<any[]>
