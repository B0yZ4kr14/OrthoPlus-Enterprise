...
export interface IUsuariosRepository {
  ...
  findProfileByIdAndClinic(id: string, clinicId: string): Promise<profiles | null>
  ...
  updateOwnProfile(id: string, data: Prisma.profilesUpdateInput): Promise<profiles>
  deleteProfilesByIdAndClinic(id: string, clinicId: string): Promise<Prisma.BatchPayload>
  findUsersByIds(ids: string[]): Promise<Pick<users, "id" | "email" | "last_sign_in_at">[]>
