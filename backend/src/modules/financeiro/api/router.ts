...
export function createFinanceiroRouter(): Router {
  ...
  router.patch("/transactions/:id", (req, res) =>
    c.updateTransaction(req, res),
  );
  router.delete("/transactions/:id", (req, res) =>
    c.deleteTransaction(req, res),
  );
  router.patch("/transactions/:id/pay", (req, res) =>
    c.markTransactionAsPaid(req, res),
  );
  ...
  router.patch("/cash-registers/:id", (req, res) =>
    c.updateCashRegister(req, res),
  );
  router.delete("/cash-registers/:id", (req, res) =>
    c.deleteCashRegister(req, res),
  );
  ...
  router.patch("/contas-receber/:id", (req, res) =>
    c.updateContaReceber(req, res),
  );
  router.delete("/contas-receber/:id", (req, res) =>
    c.deleteContaReceber(req, res),
  );
  // Alias para compatibilidade com frontend legado (usa underline)
  router.patch("/contas_receber/:id", (req, res) =>
    c.updateContaReceber(req, res),
  );
  ...
  router.delete("/contas-pagar/:id", (req, res) =>
    c.deleteContaPagar(req, res),
  );

  // Notas Fiscais
  router.get("/notas-fiscais", (req, res) => c.listNotasFiscais(req, res));
  router.post("/notas-fiscais", (req, res) => c.createNotaFiscal(req, res));
  router.patch("/notas-fiscais/:id", (req, res) =>
    c.updateNotaFiscal(req, res),
  );
  router.delete("/notas-fiscais/:id", (req, res) =>
    c.deleteNotaFiscal(req, res),
  );
  ...
  router.post("/jobs/execute", c.manageFinanceiroJobs);

  // Legacy Payments
  router.post("/cobranca/enviar", c.enviarCobranca);
