...
const DEFAULT_LIMIT = parseInt(process.env.SEARCH_RATE_LIMIT_PER_MINUTE || "30", 10);
const VIP_LIMIT = parseInt(process.env.SEARCH_RATE_LIMIT_VIP_PER_MINUTE || "100", 10);
