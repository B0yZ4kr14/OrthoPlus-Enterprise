export interface IProcedimentosRepository {
  ...
  updateManyTabelas(where: Record<string, unknown>, data: Record<string, unknown>): Promise<unknown>
  ...
  reajustarPrecos(fator: number, tabelaPrecoId: string, clinicId: string): Promise<void>
  ...
  updateDentistaProc(id: string, data: Record<string, unknown>): Promise<unknown>
