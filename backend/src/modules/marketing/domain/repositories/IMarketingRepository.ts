...
export interface IMarketingRepository {
  ...
  createCampaign(
    data: Prisma.marketing_campaignsCreateInput,
  ): Promise<marketing_campaigns>;
  updateCampaign(
    id: string,
    clinicId: string,
  ...
  // campanha_envios
  listEnvios(
    where: Prisma.campanha_enviosWhereInput,
  ): Promise<campanha_envios[]>;
  createEnvio(
    data: Prisma.campanha_enviosCreateInput,
  ): Promise<campanha_envios>;
  ...
  findRecentAppointmentPatientIds(
    clinicId: string,
    since: Date,
  ): Promise<any[]>;
  ...
  findPatientsByIds(
    clinicId: string,
    ids: string[],
  ): Promise<Pick<patients, "id" | "full_name" | "email">[]>;
  findPatientsNotInIds(
    clinicId: string,
    ids: string[],
  ): Promise<Pick<patients, "id" | "full_name" | "email">[]>;
  findPatientsByBirthday(
    clinicId: string,
    month: number,
    day: number,
  ): Promise<
