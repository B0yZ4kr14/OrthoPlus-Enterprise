...
import {
  GetVendaQueryHandler,
  GetVendaQuery,
} from "../application/queries/GetVendaQuery";
import {
  ListVendasQueryHandler,
  ListVendasQuery,
} from "../application/queries/ListVendasQuery";
import {
  GetVendasPorCaixaQueryHandler,
  GetVendasPorCaixaQuery,
} from "../application/queries/GetVendasPorCaixaQuery";
