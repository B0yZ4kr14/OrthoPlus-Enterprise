#!/bin/bash
# =============================================================================
# PostgreSQL Backup Script - OrthoPlus Enterprise (Docker)
# =============================================================================
# Backup diario automatizado com retencao de 7 dias
# Para VPS com PostgreSQL em container Docker
#
# Crontab: 0 2 * * * /home/tsi/OrthoPlus-Enterprise/scripts/backup-postgres-docker.sh
# =============================================================================
...
# Realizar backup via docker exec
echo "📦 Creating backup from container '${CONTAINER_NAME}'..."
if docker exec "${CONTAINER_NAME}" pg_dump -U "$DB_USER" -d "$DB_NAME" -F p > "$BACKUP_FILE"; then
