...
BACKUP_DIR="/home/ubuntu/backups/20260408_120926"
mkdir -p $BACKUP_DIR
...
tar -czf $BACKUP_DIR/app_v3_source.tar.gz -C /home/ubuntu OrthoPlus-Enterprise-v3/
...
ls -t /home/ubuntu/backups/ | tail -n +15 | xargs -I {} rm -rf /home/ubuntu/backups/{}
