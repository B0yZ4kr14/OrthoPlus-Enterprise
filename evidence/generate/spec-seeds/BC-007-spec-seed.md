# Fiscal Compliance — Specification Seed
*Seeded from BC-007. Evidence: [domain-model.md](../../discovery/domain-model.md) · [qa-context.json](../../qa/qa-context.json) · [risk-scores.json](../../security/risk-scores.json)*

## 1. Intent
Fiscal Compliance must support business operations securely and reliably, maintaining compliance with HIPAA, LGPD, and OWASP-ASVS.
...
- V-005: Government API errors may leak sensitive data in logs (Probable)
