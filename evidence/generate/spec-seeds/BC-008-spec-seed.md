# Medical Imaging & Files — Specification Seed
*Seeded from BC-008. Evidence: [domain-model.md](../../discovery/domain-model.md) · [qa-context.json](../../qa/qa-context.json) · [risk-scores.json](../../security/risk-scores.json)*

## 1. Intent
Medical Imaging & Files must support business operations securely and reliably, maintaining compliance with HIPAA, LGPD, and OWASP-ASVS.
...
- Encryption: TLS in transit; S3 SSE for storage

Known gaps to close:
- Encryption-at-rest not verified on MinIO

Open vulnerabilities:
- V-004: Medical images stored without encryption-at-rest check (Potential)
- V-006: No file size limit on radiograph uploads (Potential)
