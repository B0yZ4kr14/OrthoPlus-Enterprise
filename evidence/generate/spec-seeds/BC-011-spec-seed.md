# Reporting — Specification Seed
*Seeded from BC-011. Evidence: [domain-model.md](../../discovery/domain-model.md) · [qa-context.json](../../qa/qa-context.json) · [risk-scores.json](../../security/risk-scores.json)*

## 1. Intent
Reporting must support business operations securely and reliably, maintaining compliance with HIPAA, LGPD, and OWASP-ASVS.
