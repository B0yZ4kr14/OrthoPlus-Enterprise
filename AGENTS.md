...
This project is indexed by GitNexus as **OrthoPlus-Enterprise** (31.881 nodes, 66.400 edges, 883 clusters, 266 flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
