---
description: Convert legacy .NET Framework project file to SDK-style format; validate
  with build-fix
tools:
- microsoft.githubcopilot.modernization.mcp/convert_project_to_sdk_style
- read
- edit
- search
- ask-questions
