...
description: Synthesize assessment findings into actionable, layered migration plan
  with chunked package updates
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: fx-to-dotnet:commands/plan/plan.md
---
...
- Auto-generated from: .kimi/skills/speckit-fx-to-dotnet-plan/SKILL.md
