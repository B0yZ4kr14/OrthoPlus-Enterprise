---
agent: speckit.multi.model.review.review.package
---
...
---
name: speckit-multi-model-review-review-package
description: Export a compact multi-model review package for the reviewer model, including
  spec-author, implementation, subagent routing, and review model metadata.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: multi-model-review:commands/review-package.md
---
...
9. Select the reviewer template.
   - `codex-auto` -> `.specify/templates/codex-auto-review-prompt.md`
   - `codex-cli` -> `.specify/templates/codex-cli-review-prompt.md`
   - `codex-mcp` -> `.specify/templates/codex-mcp-review-prompt.md`
   - `codex-cli` legacy fallback -> `.specify/templates/codex-review-prompt.md`
   - `claude-code` -> `.specify/templates/claude-review-prompt.md`
   - `gemini-cli` -> `.specify/templates/gemini-review-prompt.md`
   - custom reviewer -> `.specify/templates/<id>-review-prompt.md`
   - If missing, abort with: "No template for reviewer `<id>`. Add `.specify/templates/<id>-review-prompt.md`."
...
- Auto-generated from: .kimi/skills/speckit-multi-model-review-review-package/SKILL.md
