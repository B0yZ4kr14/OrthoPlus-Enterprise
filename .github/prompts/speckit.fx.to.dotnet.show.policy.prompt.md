---
agent: speckit.fx.to.dotnet.show.policy
---
...
description: Display a named migration policy document. Domain policies (ef6-migration-policy,
  owin-identity, systemweb-adapters, windows-service-migration) and the extension-specific
  mcp-setup policy all live under fx-to-dotnet/policies/.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: fx-to-dotnet:commands/policies/show.md
---
...
- Auto-generated from: .kimi/skills/speckit-fx-to-dotnet-show-policy/SKILL.md
