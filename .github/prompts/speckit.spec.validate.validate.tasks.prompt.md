---
agent: speckit.spec.validate.validate.tasks
---
...
metadata:
  ...
  source: spec-validate:commands/validate-tasks.md
---
...
- Auto-generated from: .kimi/skills/speckit-spec-validate-validate-tasks/SKILL.md
