---
agent: speckit.fx.to.dotnet.detect
---
...
description: Read project file(s); determine SDK-style format, project classification,
  confidence level, and evidence. Accepts a single project file or a solution (.sln/.slnx)
  and classifies all projects in it. Appends results to {featureDir}/migration/plan.md.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: fx-to-dotnet:commands/detect-project/detect.md
---
...
- Auto-generated from: .kimi/skills/speckit-fx-to-dotnet-detect/SKILL.md
