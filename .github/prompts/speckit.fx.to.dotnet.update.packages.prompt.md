...
description: Execute a per-project package update plan; invoke build-fix after each
  (project, chunk) pair
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: fx-to-dotnet:commands/package-compat/update.md
---
...
- Auto-generated from: .kimi/skills/speckit-fx-to-dotnet-update-packages/SKILL.md
