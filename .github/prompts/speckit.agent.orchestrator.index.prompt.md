---
agent: speckit.agent.orchestrator.index
---
...
---
name: speckit-agent-orchestrator-index
description: Index all available commands, extensions, workflows, and presets
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: agent-orchestrator:commands/speckit.agent-orchestrator.index.md
---
...
- Auto-generated from: .kimi/skills/speckit-agent-orchestrator-index/SKILL.md
