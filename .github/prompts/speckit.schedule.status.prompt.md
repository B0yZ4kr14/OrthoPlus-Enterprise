...
description: Self-diagnose the schedule extension's installation state. Reports five
  checks (extension files, hook registration, solver deps, portfolio config, run history)
  and distinguishes real problems from expected pre-first-run state.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: schedule:commands/status.md
---
...
- Auto-generated from: .kimi/skills/speckit-schedule-status/SKILL.md
