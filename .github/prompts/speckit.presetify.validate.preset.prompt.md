---
agent: speckit.presetify.validate.preset
---

# speckit.presetify.validate.preset
...
Scan the `.specify/templates/` and `commands/` subdirectories (if they exist) for `.md` files that are **not** referenced by any entry in `provides.templates`. Report these as warnings — they exist but won't be used.
...
⚠️  .specify/templates/draft-template.md: not referenced in preset.yml
...
- Auto-generated from: .kimi/skills/speckit-presetify-validate-preset/SKILL.md
