...
---
name: speckit-catalog-ci-diff
description: Compare catalog against a git ref to show added, modified, and removed
  entries
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: catalog-ci:commands/speckit.catalog-ci.diff.md
---
...
- Auto-generated from: .kimi/skills/speckit-catalog-ci-diff/SKILL.md
