---
agent: speckit.agent.orchestrator.discover
---
...
---
name: speckit-agent-orchestrator-discover
description: Discover agents and capabilities across linked repositories
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: agent-orchestrator:commands/speckit.agent-orchestrator.discover.md
---
...
- Auto-generated from: .kimi/skills/speckit-agent-orchestrator-discover/SKILL.md
