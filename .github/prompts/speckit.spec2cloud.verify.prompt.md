---
agent: speckit.spec2cloud.verify
---

# speckit.spec2cloud.verify
...
---
name: speckit-spec2cloud-verify
description: Verify locally that the implemented feature is ready to be deployed to
  Azure by running it against local servers (with Azure-only dependencies provisioned
  first).
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: spec2cloud:commands/speckit.spec2cloud.verify.md
---
...
- Auto-generated from: .kimi/skills/speckit-spec2cloud-verify/SKILL.md
