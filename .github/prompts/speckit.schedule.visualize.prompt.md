---
agent: speckit.schedule.visualize
---
...
description: Render the solved schedule as a static Gantt chart and dependency DAG
  (PNG/SVG) and embed them into schedule.md alongside the inline Mermaid diagrams.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: schedule:commands/visualize.md
---
...
- Auto-generated from: .kimi/skills/speckit-schedule-visualize/SKILL.md
