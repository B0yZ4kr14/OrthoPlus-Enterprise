---
agent: speckit.canon.drift.reverse
---
...
---
name: speckit-canon-drift-reverse
description: Reverse-engineer tasks from implementation and identify task-level drift
  against the original `tasks.md` — write only drifted tasks to `tasks.drift.md`.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: canon:commands/drift-reverse.md
---
...
**Before doing anything else**, run `bash .specify/extensions/canon/scripts/bash/check-prerequisites.sh --json --require-tasks` from repo root and parse JSON for `REPO_ROOT`, `BRANCH`, `FEATURE_DIR`, `FEATURE_SPEC`, `TASKS`, `TASKS_DRIFT`, and `BASE_BRANCH`. All path values must be absolute.
...
- Auto-generated from: .kimi/skills/speckit-canon-drift-reverse/SKILL.md
