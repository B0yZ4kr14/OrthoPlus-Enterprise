---
agent: speckit.agent.orchestrator.route
---
...
---
name: speckit-agent-orchestrator-route
description: Match a user prompt to the best-fit command across all catalogs
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: agent-orchestrator:commands/speckit.agent-orchestrator.route.md
---
...
- Auto-generated from: .kimi/skills/speckit-agent-orchestrator-route/SKILL.md
