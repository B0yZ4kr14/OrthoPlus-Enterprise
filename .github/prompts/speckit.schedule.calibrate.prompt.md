---
agent: speckit.schedule.calibrate
---
...
description: Recalibrate the portfolio's speed_factor and token_estimates from accumulated
  execution logs in .specify/schedule/runs/.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: schedule:commands/calibrate.md
---
...
- Auto-generated from: .kimi/skills/speckit-schedule-calibrate/SKILL.md
