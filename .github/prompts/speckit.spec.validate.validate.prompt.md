---
agent: speckit.spec.validate.validate
---
...
**For critical items:**
1. Load `.specify/templates/distractor-patterns.yml` to determine the distractor pattern category:
...
- Auto-generated from: .kimi/skills/speckit-spec-validate-validate/SKILL.md
