...
---
name: speckit-schedule-solve
description: Parse tasks.md, solve the CP-SAT scheduling model, and produce schedule.md
  with agent assignments, execution waves, and a Gantt diagram.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: schedule:commands/schedule.md
---
...
- Auto-generated from: .kimi/skills/speckit-schedule-solve/SKILL.md
