...
---
name: speckit-maqa-jira-setup
description: Bootstrap Jira config for MAQA. Lists projects and workflow statuses
  via the Jira REST API v3 and generates maqa-jira/jira-config.yml. Run once per project.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: maqa-jira:commands/speckit.maqa-jira.setup.md
---
...
- Auto-generated from: .kimi/skills/speckit-maqa-jira-setup/SKILL.md
