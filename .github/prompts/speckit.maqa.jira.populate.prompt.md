---
agent: speckit.maqa.jira.populate
---

# speckit.maqa.jira.populate
...
---
name: speckit-maqa-jira-populate
description: Populate Jira project from specs/*/tasks.md. Creates one Story per feature
  with Subtasks per task item. Skips features already in the project. Safe to re-run.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: maqa-jira:commands/speckit.maqa-jira.populate.md
---
...
- Auto-generated from: .kimi/skills/speckit-maqa-jira-populate/SKILL.md
