...
description: after_plan hook (mandatory). Run assess + plan to produce {featureDir}/migration/analysis.md
  and {featureDir}/migration/plan.md, then annotate spec.md and plan.md with extension-managed
  migration sections. Silent-exit success on non-Framework solutions. Idempotent.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: fx-to-dotnet:commands/hooks/plan-hook.md
---
...
- Auto-generated from: .kimi/skills/speckit-fx-to-dotnet-plan-hook/SKILL.md
