---
agent: speckit.onboard.start
---

# speckit.onboard.start
...
description: 'Spec-kit workflow command: speckit-onboard-start'
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: onboard:commands/start.md
---
...
- Auto-generated from: .kimi/skills/speckit-onboard-start/SKILL.md
