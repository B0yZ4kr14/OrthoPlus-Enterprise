---
agent: speckit.markitdown.convert
---
...
---
name: speckit-markitdown-convert
description: Convert a document to Markdown and place it in the spec directory as
  reference material
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: markitdown:commands/convert.md
---
...
- Auto-generated from: .kimi/skills/speckit-markitdown-convert/SKILL.md
