---
agent: speckit.fx.to.dotnet.tasks.hook
---
...
description: 'after_tasks hook (mandatory). Dedupe migration-themed tasks, insert
  a `## Phase 1: .NET Framework Migration` block ahead of all existing phases (renumbering
  them by +1), and emit granular [MIG-*] tasks each carrying a `dispatch: speckit.fx-to-dotnet.<command>(<args>)`
  trailer. Silent-exit on non-Framework solutions. Idempotent.'
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: fx-to-dotnet:commands/hooks/tasks-hook.md
---
...
- Auto-generated from: .kimi/skills/speckit-fx-to-dotnet-tasks-hook/SKILL.md
