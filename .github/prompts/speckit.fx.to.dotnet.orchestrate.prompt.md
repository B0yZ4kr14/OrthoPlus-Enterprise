---
agent: speckit.fx.to.dotnet.orchestrate
---

# speckit.fx.to.dotnet.orchestrate
...
description: Orchestrate end-to-end .NET Framework to modern .NET migration across
  7 phases
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: fx-to-dotnet:commands/orchestrate/orchestrate.md
---
...
- Auto-generated from: .kimi/skills/speckit-fx-to-dotnet-orchestrate/SKILL.md
