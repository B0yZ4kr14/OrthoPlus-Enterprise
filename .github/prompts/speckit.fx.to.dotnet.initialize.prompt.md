---
agent: speckit.fx.to.dotnet.initialize
---
...
description: 'Initialize migration state: resolve solution path and target framework,
  resolve the active Spec Kit feature directory, create the {featureDir}/migration/
  artifact directory (which holds analysis.md, plan.md, and the orchestrator state
  file orchestration.md), and establish path conventions for downstream commands'
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: fx-to-dotnet:commands/initialize/initialize.md
---
...
- Auto-generated from: .kimi/skills/speckit-fx-to-dotnet-initialize/SKILL.md
