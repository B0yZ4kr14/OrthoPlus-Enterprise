---
agent: speckit.maqa.azure.devops.setup
---
...
---
name: speckit-maqa-azure-devops-setup
description: Bootstrap Azure DevOps config for MAQA. Reads organization, project,
  and board columns via REST API and generates maqa-azure-devops/azure-devops-config.yml.
  Run once per project.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: maqa-azure-devops:commands/speckit.maqa-azure-devops.setup.md
---
...
- Auto-generated from: .kimi/skills/speckit-maqa-azure-devops-setup/SKILL.md
