---
agent: speckit.canon.vibecode.drift
---
...
---
name: speckit-canon-vibecode-drift
description: Vibecoding drift orchestrator — runs the full vibecoding drift-to-canon
  pipeline in default manual review mode or explicit automatic remediation mode; analyze
  stays direct, and analyze remediation is handled by the orchestrator before canonize.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: canon:commands/vibecode-drift.md
---
...
Before starting Step 1, run `bash .specify/extensions/canon/scripts/bash/check-prerequisites.sh --json --canon` from repo root and parse JSON for
...
- Auto-generated from: .kimi/skills/speckit-canon-vibecode-drift/SKILL.md
