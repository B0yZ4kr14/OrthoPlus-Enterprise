...
description: Plan and execute ASP.NET Framework to ASP.NET Core migration; create
  side-by-side host; port artifacts in slices
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: fx-to-dotnet:commands/web-migrate/migrate.md
---
...
- Auto-generated from: .kimi/skills/speckit-fx-to-dotnet-web-migrate/SKILL.md
