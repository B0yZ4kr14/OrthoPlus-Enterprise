...
| **Project Size** | 3059 files, ~342K lines                                     |
...
OrthoPlus-Enterprise is a TypeScript ^5.8.3 application.
...
| -------------- | ----------------- | ---------------- |
| Technical      | TypeScript ^5.8.3 | Primary language |
...
\`\`\`mermaid
graph TD
U[Users/Clients] --> S[OrthoPlus-Enterprise]
S --> DB[(Database)]
...
| ------- | ---------- | ----------------- | ----------------------------------- |
| 0.1.0   | 2026-05-26 | DocGuard Generate | Auto-generated (arc42 + C4 aligned) |
